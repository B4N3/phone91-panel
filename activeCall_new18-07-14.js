...
fs.appendFile('/home/voicepho/nodeError', 'start', function (err) {
    console.log(err);
});
...
//    });
    ...
    fs.appendFile('/home/voicepho/nodeError', ' sessionHandler ', function (err) {
    console.log(err);
    });
...
fs.appendFile('/home/voicepho/nodeError', ' connection ', function (err) {
    console.log(err);
    });
    ...
    if(!exist)
    {
         pool.getConnection(function(err, connection) {
                ...
                connection.query(sql,function(error, rows,fields){
                 ...
                 fs.appendFile('/home/voicepho/nodeError', ' currencyError '+error, function (err) {
                    console.log(err);
                    });
                   ...
                   for(i=0;i<rows.length;i++){
                      ...
                      currArr = currData;
                   fs.appendFile('/home/voicepho/nodeError', ' currencydata '+currData, function (err) {
                    console.log(err);
                    });
                });
...
io.set('authorization', function(handshake, callback) {
 ...
 fs.appendFile('/home/voicepho/nodeError', ' step2 ', function (err) {
                    console.log(err);
                    });
...
function getDataFromDb(socket,pool)
{
    ...
    pool.getConnection(function(err, connection) {
         fs.appendFile('/home/voicepho/nodeError', ' pool connection '+err, function (err) {
                    console.log(err);
                    });
//        var chainIdEsc = sanitizer.sanitize(globalID.chainId); 
       ...
       // console.log("chain Id::"+JSON.stringify(chainIdEsc));
        ...
        connection.query(sql,function(error, rows,fields){
            ...
            fs.appendFile('/home/voicepho/nodeError', ' pool connection '+error+'Q'+sql, function (err) {
                    console.log(err);
                    });
...
//            pool.getConnection(function(err, connection) {
               console.log("chain"+chainIdStr);
                fs.appendFile('/home/voicepho/nodeError', ' chainid '+chainIdStr, function (err) {
                    console.log(err);
                    });
               if(chainIdStr != ""){
                ...
                connection.query("select name,chainId,userName from 91_manageClient where chainId IN ("+chainIdStr+")",function(error, result,fields){
                 //   console.log(error);
                  fs.appendFile('/home/voicepho/nodeError', ' manageClientError '+error, function (err) {
                    console.log(err);
                    });
                    var j;
                    nameArr = [];
...
//            });
      ...
      fs.appendFile('/home/voicepho/nodeError', ' sqlresultsocket ', function (err) {
                    console.log(err);
                    });
...
function getCounter(socket,pool)
{
    var chainIdEsc = sanitizer.sanitize(connectChainArrTwo[socket.id]); 
        ...
        fs.appendFile('/home/voicepho/nodeError', ' getcounter chain id '+chainIdEsc, function (err) {
                    console.log(err);
                    });
  ...
  pool.getConnection(function(err, connection) { 
      //console.log(err);
       fs.appendFile('/home/voicepho/nodeError', ' currentcall sql error '+err, function (err) {
                    console.log(err);
                    });
        connection.query(sql,function(error, rows,fields){
           fs.appendFile('/home/voicepho/nodeError', ' currentcall sql errorQ '+sql, function (err) {
                    console.log(err);
                    });
            //res.writeHead(200,{'Content-Type':'text/plain'});
...
//     sessionHandler(socket);
  ...
  //  console.log("session id 2 :"+JSON.stringify(globalID));
    ...
    if(globalID !== "undefined")
    {
        ...
        fs.appendFile('/home/voicepho/nodeError', ' socket emit  '+userdata, function (err) {
                    console.log(err);
                    });
        ...
        socket.on('disconnect', function() {
            ...
            fs.appendFile('/home/voicepho/nodeError', ' socket disconnect ', function (err) {
                    console.log(err);
                    });
