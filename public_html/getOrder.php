...
include('config.php');
//die();
//echo dirname(__FILE__)."/paymentConfig.php";
...
if(!isset($_SESSION['currencyName']))
{
    die('session has been expired Please try again');
}

//get currencycode
$currencyCodeType=$_SESSION['currencyName'];
