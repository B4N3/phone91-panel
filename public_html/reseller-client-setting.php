    ...
    <div id="tabs-1" class="tabs">
    	<div id="transactionTable" class="tablflip-scroll pr">
            ...
            <tbody>
                ...
                <?php
						$totalCredit = (float)$totalCredit + (float)$trans['creditActualCurrency'];
						$totalDebit = (float)$totalDebit + (float)$trans['debitActualCurrency'];
                ...
                <tr class="">
                    ...
                    <td class="alR"><span class="debit"><?php echo round($totalDebit,2) ;?></span></td>
                    <td class="alR"><?php echo round($totalCredit,2); ?></td>
               ...
               <div class="actionDiv">
                ...
                if(!isset($_SESSION['isAdmin'])) 
                    ...
                    $admin = $_SESSION['isAdmin'];
                        $result = $planObj->getPlanName("planName,tariffId,outputCurrency",$_SESSION['userid'],2,NULL,$admin);
...
function designTransactionLog(text){
 ...
 else if(closeBal < 0)
 {
  ...
  str += '<tr class="hvrParent">\
    ...
    totalCredit = parseFloat(totalCredit) + parseFloat(item.creditActualCurrency);
    totalDebit = parseFloat(totalDebit) + parseFloat(item.debitActualCurrency);
    ...
    str+= '<tr class="zerobal">\
                ...
                <tr class="">\
                    ...
                    <td  class="alR">&nbsp;</td>\
                    <td>&nbsp;</td>\
                    <td class="alR"><span class="debit">'+totalDebit.toFixed(2)+'</span></td>\
                    <td class="alR">'+totalCredit.toFixed(2)+'</td>\
