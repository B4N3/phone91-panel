    	...
    	<div id="transactionTable" class="tablflip-scroll pr">
        	...
        	<thead>
                <tr>
                    ...
                    <th width="10%"><div class="fr"><span class="fl"><div class="fxhdrtxt">Talktime</div></span><i title="The amount of calling funds added/given in this users/resellers account with the money received/given." class="ic-16 helpW"></i></div></th>
                    <th width="13%"><div class="fr"><span class="fl"><div class="fxhdrtxt">Total talktime</div></span><i title="This is the total talktime received/given till date. " class="ic-16 helpW"></i></div></th>
                    <th width="23%" class="ellpTh"><div class="fxhdrtxt">Description</div></th>
                    <th width="9%"><div class="fr"><span class="fl"><div class="fxhdrtxt">Debit</div></span><i title="Money you need to take from <?php echo $userInfo['userName'];?>" class="ic-16 helpW"></i></div></th>
                    ...
                    <th width="14%"><div class="fr"><span class="fl"><div class="fxhdrtxt">Closing Balance</div></span><i title="Positive closing balance indicates the money you need to take from <?php echo $userInfo['userName'];?>, while negative closing balance indicates the services due to <?php echo $userInfo['userName'];?> with the given money." class="ic-16 helpW"></i></div></th>
                </tr>
            </thead>
            <tbody>
                <?php
                ...
                $closeBalance = round($totalClosingBalance,2);
                      if($closeBalance > 0)
                      {
                        $totalClosingBalance =  'You need to give '.$closeBalance;
                        $closeClass = 'debit';
                      }
                      else if($closeBalance < 0)
                      { 
                        $closeBalText = substr($closeBalance, 1,strlen($closeBalance)-1);
                       $totalClosingBalance= 'You need to take '.$closeBalText;
                       $closeClass = 'green';
                                  ...
                                  <div class="actionDiv">
                                       <div class="fields sporow">   
                                            <label><span class="fl mrB">Recharge amount<sup>*</sup></span>
                                            	<i title="Amount of the talktime you are giving or receiving" class="ic-16 help"></i>
                                            </label>
...
<!--                                            <span class="funder">
                                  ...
                                  <div id="talktime" class="actionDiv"> 
                                      <div class="fields"> 
                                            <label><p class="fl mrB">Talktime<sup>*</sup></p>
                                            	<i title="Talktime or Calling balance you are giving or receiving" class="ic-16 help"></i>
                                            </label>
    ...
    <div id="tabs-3" class="tabs displayEditInfo"><!--display number and email info-->
           ...
           <div class="clear">
               <div class="actionDiv">
                    <div class="fields">
                        <label><span class="fl mrB">Call Limit</span> <i class="ic-16 help mrL fl" title="The maximum concurrent calls this user/reseller would be able to make at one time. "></i></label>
            ...
            <table class="mrT2" border="1" bordercolor="#ddd">
            	<tr>
...
//js for dot dot ellipsis in td
var _P= $('.ellpTh').outerWidth(true)
$('.ellp').css({width: _P-20})
