...
<!--    	<div id="pagiwrap">
        ...
        <div id="add-shop-dialog" class="dn" title="Add System">
            <div id="add-shop-inner">
            	<div class="col-5">
              		<div class="addform"> 
                        <form name="addSystemForm" id="addSystemForm" action="" method="post">
                            ...
                            <div class="rdrow"><input type="radio" id="sip" name="sysID" value="0" checked="checked" onclick="sipSetting();"/><label for="sip">Sip</label></div>
                            <div class="rdrow"><input type="radio" id="messenger" name="sysID" value="1" onclick="messengerSetting();"/><label for="messenger">Messenger Id</label></div>

                            <div id="messengerDiv" class="messengerCls" style="display: none">                            
                            <input id="messengerId" name="messengerId" class=" messengerIdCls" type="text" value="" placeholder="Select id  &rarr;" readonly="readonly"/>
                ...
                <div id="addShopIdList" class="col-5 addShopIdListCls">
                    <div class="wrp">
                        <div class="pdL2">
...
{
    $('#submitButtonCS').show();
    $('#submitButtonCS').val('Add System');
	$('.messengerCls').hide();
    $('.messengerIdCls').removeClass('required');    
	$('#submitButtonCS').val('Generate');
	$('.addShopIdListCls').hide();
}
...
function messengerSetting()
{
    $('#submitButtonCS').show();
    $('#submitButtonCS').val('Add System');
    toggleElement('.messengerCls','#sipDiv');    
...
function toggleElement(toShow,toHide)
{
   /* @AUTHOR :Ankit Patidar
    * @DESC : TOGGLE THE element FOR THREE OPTIONS IE SELECT BROWSE AND MANUAL
    */
    $(toShow).show();
    $(toHide).hide();
} 
...
function getVerifiedEmailDetails(){
