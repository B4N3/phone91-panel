...
<table width="100%" cellspacing="0" cellpadding="0" border="0" class="cmntbl  boxsize" id="editfundLog">
	...
	<th width="10% noBorder">Access Number</th>
        <th width="10% noBorder">Duration</th>
        <th width="10% noBorder">Unique Id</th>
        ...
        var str = "";
               ...
               $.each(response,function(key,value){
                   ...
                   if(value['type'] == '4')
                    {
                        var type = '1';
                        var url = 'http://voice.phone91.com/wow/index.php#!manage-client.php?q='+$.base64.encode(value['userName'])+'&qs='+$.base64.encode(value['id_client'])+'&type='+type+'|batchDetail.php?batchId='+value['userBatchId']+'&token='+$.base64.encode(value['userName']);
                    }
                    else 
                    {
                         var type = '0';
                         var url = 'http://voice.phone91.com/wow/index.php#!manage-client.php?q='+$.base64.encode(value['userName'])+'&qs='+$.base64.encode(value['id_client'])+'&type='+type+'|transactional.php?clientId='+value['id_client']+'&tb=0';
                    }
                   ...
                   if(value['userName'] != undefined && value['userName'] != null)
                     str += "<tr class='"+clss+"'>\
                            <td><a href='"+url+"' >"+value['userName']+"</a></td>\
			    ...
			    <td class='alC '>"+value['didNumber']+"</td>\
                            <td class='alC '>"+value['duration']+"</td>\
                            <td class='alC '>"+value['uniqueId']+"</td>\
                            </tr>";
               })
              return str;
    }
