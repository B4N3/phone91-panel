    ...
    $.each(response.data,function(key,value){
                str += '<li onclick="liClick(event,\''+value.id+'\')" class="active">\
					<div class="tariff">\
							...
							<p>Country Wise</p>\
							<p class="clear mrT1">\
                                                            <div class="funder"><span class="ic-24 delete cp" title="Delete" onclick="deletePlan(\''+value.id+'\',$(this))"></span></div>\
								No. of Prefix: <span class="font15 blackThmCrl">'+(value.count == null?"0":value.count)+'</span>\
							</p>\
					  </div>\
        	  </li>';
                })
