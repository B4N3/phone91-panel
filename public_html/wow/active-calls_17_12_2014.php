           ...
           $.each(jsonData, function(i, obj) {
            ...
            // console.log(obj);
              ...
              //  console.log("call duration"+(callduration/60).toFixed(2).split("."));
                ...
                str +='<div class="acBox">\
                        <div class="in">\
                            <h3><a href="http://voice.phone91.com/wow/index.php#!manage-client.php?q='+$.base64.encode(obj.userName)+'&qs='+$.base64.encode(obj.id_client)+'|transactional.php?clientId='+obj.id_client+'&tb=0" >'+obj.userName+'</a></h3><h3>'+bn+'</h3>\
