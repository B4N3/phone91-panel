          ...
          success:function(response){
              ...
              if(response.status == "success")
              {
                 ...
                 <td colspan="100%">\
                   ...
                   <td><input type="text" countryId="'+response.lastInsertId+'" value="" class="isInput120 uPrefix"/></td>\
                   <td>\
				   		<select name="" class="isInput150 selRoute">\
							'+_globalRoute+'\
						</select>\
				   </td>\
                   <td>\
...
//                             $('#prefixTableBody').prepend(str1);
    ...
    {
           var str = "";
		   var sel = $('<select>').addClass('selRoute');
		   sel.append(_globalRoute);
                 ...
                 <td colspan="100%">\
                 	<span class="fl db mrR1 mrT1">'+value.country+'</span>\
                     <p class="arBorder fl cp sucsses" title="Add" onclick="addRow($(this))">\
                        <span class="ic-12 add "></span>\
                    </p>\
                </td>\
            </tr>';
                            if(value.prefix == null || value.prefix === undefined)
                            {
                                str += '<tr class="even">\
                   <td><input type="text" countryId="'+value.slno+'" value="" class="isInput120 uPrefix"/></td>\
                   <td>\
				   		<select name="" class="isInput150 selRoute">\
							'+_globalRoute+'\
						</select>\
                   ...
                   <td>&nbsp;</td>\
                            ...
                            $.each(value.prefix,function(keyOne,valueOne){								
                                ...
                                str += '<tr class="even">\
                   <td><input type="text" countryId="'+value.slno+'" value="'+valueOne.userPrefix+'" class="isInput120 uPrefix"/></td>\
                   <td>'+selStr+'</td>\
                   <td>\
				  		<div class="fr mrL2">\
