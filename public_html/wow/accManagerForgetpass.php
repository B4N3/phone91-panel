...
function reset_pass()
{
   ...
   //validation for password
    ...
    else if(n1 == n2)
    {
		...
		$.ajax({type: "POST",
                        url: "/controller/acmController.php?action=resetAdminPassword",
                        data: {new_pwd:n1},
                        dataType:"json",
                        success: function(response)
                            {
                                    ...
                                    if(response.status == "error")//if problem in password
                                    {
                                            $("#new_pwd").addClass("error_red");
                                            $("#confirm_pwd").addClass("error_red");
                                            $("#new_pwd").attr('value','');
        ...
        if(uname != "")
         {
            ...
            $.ajax({url:"/controller/acmController.php?action=accManagerForgetPass",
