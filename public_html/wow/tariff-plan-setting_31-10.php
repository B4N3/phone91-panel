...
<div class="planrowEdit dn" id="planrowEdit">
    <form name="editPlanAdmin" id="editPlanAdmin" method="post">
        ...
        <input type="hidden" id="idName" value="editPlanAdmin"/>   
     ...
     <span class="fl text">Output Currency</span>
        <select class="currency" name="outputCurr">
...
<div id="formWrap"> 
    ...
    <div id="tabs-2" class="mrB1 pr">
            ...
            <a href="javascript:void(0)" class="textAb" title="Download sample .csv file"><span class="fl  themeClr">Download sample .csv file</span></a>
    ...
    <div class="cmnReplace clear oh mrB2">
        <div class="fl mrT1 mrL1" id="replaceDiv">
