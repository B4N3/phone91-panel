...
<div id="tabs" class="mngClntFnction">
    <ul>
			...
			<li><a href="#tabs-4" title="Settings"><span class="ic-40 setting"></span></a></li>
             <li><a href="#tabs-5" title="Latest info"><span class="ic-40 latestinfo"></span></a></li>
   </ul>
    	...
    	<form class="formElemt settingform">
            ...
            <div class="rightSetForm">
                ...
                <div class="fields ">
                   ...
                   <input type="text" placeholder="+19 - 893073345"/>
              </div>
              
                <div class="fields">
                    <label>Email</label>
                   <input type="text" placeholder="jsm@gmail.com"/>
              </div>
               ...
               <div class="add clear oh mrB2">
                   ...
                   <input type="password" placeholder="Inter new Password" class="fl"/>
                   <p title="Reset Password" class="arBorder secondry fl cp reset cp">
    ...
    <div id="tabs-5">
    	 <div class="tablflip-scroll" id="transactionTable">
      		   ...
      		   <table width="100%" cellspacing="0" cellpadding="0" border="0" class="cmntbl  boxsize mrT1" id="clientTrstable">
                    <thead>
                        <tr>
                            <th width="20%">Latest Login Time  </th>
                            <th width="20%">Ip's</th>
