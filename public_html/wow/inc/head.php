...
<!--                  <li class="clear" onclick="window.location.href='#!setting.php|buymore.php'"> 
                  ...
                  <li class="clear"> 
                      <span  title="Logout" onclick="var url = window.location.hash;window.location.href='<?php echo ADMIN_DIR;?>logout.php?url='+url.substring(1)">Logout</span> 
                  </li>
                </ul>
              </li>
               <li>
    ...
    <form id="bulkmailsend" class="">
        <div class="send-inner">
            ...
            <div class="clear irow">
                ...
                <label for="checkUsersToMail"><strong>Users</strong></label> &nbsp;
                <input id="checkResellersToMail" type="checkbox" class="mrL1" name="sendReseller" />
                <label for="checkResellersToMail" class="danger">Reseller</label>
        	</div>
        ...
        <form id="bulkSmsSend" class="">
            <div class="send-inner">
                ...
                <div class="clear irow">
                    ...
                    <label for="checkUsersToSms"><strong>Users</strong></label>
                    <input id="checkResellersToSms" type="checkbox" class="mrL1" name="sendResellerSms"/>
                    <label for="checkResellersToSms" class="danger">Reseller</label>
                    <input id="CheckChainToSms" type="checkbox" class="mrL1" name="sendAllChain"/>
                    <label for="CheckChainToSms" class="danger">All Chain</label>
                </div>
