...
<!--	<input type="checkbox" name="rememberMe" id="rememberMe" value="" tabindex="3"/>Remember Me<br />	    -->
    ...
    <input type="submit" name="submit" id="submitbutton" tabindex="4" value="Login"  onsubmit="return validateLogin()" class="fl mrB1 crs db bdrN btn rdbtn awesome large green" />
<p class="borderBottom"><a href="#forgetpass.php" onclick="$('#forgotPassword').load('accManagerForgetpass.php')">Forgot Password</a></p>
