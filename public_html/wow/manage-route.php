...
if (!$funobj->login_validate() || !$funobj->check_admin() || !isset($_SESSION['userid'])) {
                       ...
                       // if(value.deleteFlag == 0)
                        ...
                        var balance = parseFloat(value.balance);
                                    str += '<li onclick="loadRouteDetails('+value.id+',event);">\
                                              ...
                                              <div class="usrDescr">\
                                                <div class="">\
                                                  <h3 class="blackThmCrl">\
                                                            '+value.routeName+'</h3>\
                                                  <h3 class="yelloThmCrl ellp"></h3>\
                                                  <span></span>\
                                                  <p class="acMan"></p>\
                                                  <p class="tInfo">\
                                                      Tariff:\
                                                    <b>'+value.planName+'</b>\
                                                    <span class="sep">|</span>\
                                                    <span class="'+value.id+'changeRouteBal grnThmCrl">'+balance.toFixed(2)+' '+value.currency+'</span>\
                                                    <span style="position: absolute;left: 204px;top: 55px;">\
                                                      <span class="ic-12 arrowLeft"></span>\
                                                      <span style="padding: 2px;">'+value.divertedRoute+'</span>\
                                                    </span></p></div></div></li>';//\
                            //                       </p>\ 
                            //                     </div>\
                            //                   </div>\
