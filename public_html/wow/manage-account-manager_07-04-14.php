...
<div class="inner">
<!--Left Section-->
<div class="slideLeft contentHolder" id="leftsec" style="height:1000px;">
    <ul class="mngClntList" id="mngClntList" style="overflow:scroll;height: 1000px;">
                                ...
                                <span class="funder">
                                    <?php //  if($clientData["blockUnblockStatus"] != 1){
                                                       ...
                                                       //         $statusClass ="";
                                                        ...
                                                        //    }
                                                            ?>
                                    <label onclick="deleteAcm(this,<?php echo $clientData['acmId']; ?> );" for="chnage" class="ic-32 grnEnabl cp <?php echo $statusClass; ?> ">
                                    </label>
