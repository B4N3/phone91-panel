        ...
        xhr = $.ajax({
		    ...
		    console.log(msg);
                    var str = clentDetailDesign(msg.data);
                     ...
                     loadMoreDetail(2,msg.data.pages,'/action_layer.php?action=loadMoreClientByPage','clentDetailDesign','mngClntList');
                }//function end
...
function clentDetailDesign(msg){
	...
	appStatus = 1;
     ...
     var str = "";
				...
				contactStr = '<input onchange="showHide()" type="checkbox" class="check" contactToken ="'+value.uname+'" appStatus ="'+appStatus+'">';
