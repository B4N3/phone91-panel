...
<div id="resTrLogWrap" class="commLeftList">
    ...
    <div class="clear inner">
        <div id="filter">
            ...
            <input class="mrT2 btn btn-medium btn-primary" value="Go" type="submit" title="Go" onclick="getAllTransactions()">
        </div>
...
function getAllTransactions()
{
    ...
    var filterBy = $("input[name=filterBy]:checked").val();
        ...
        $.ajax({
            ...
            type:"POST",
            dataType:"JSON",
            data:"userId="+<?php echo $_SESSION['userid']; ?>+"&pageNo="+<?php echo $pageNo; ?>+"&filterBy="+filterBy,
