...
//<a href="http://voice.phone91.com/wow/index.php#!manage-client.php?q='+$.base64.encode(obj.userName)+'&qs='+$.base64.encode(obj.id_client)+'|transactional.php?clientId='+obj.id_client+'&tb=0" >


                str +='<div class="acBox">\
                        <div class="in">\
                            <h3>'+obj.userName+'</h3><h3>'+bn+'</h3>\
