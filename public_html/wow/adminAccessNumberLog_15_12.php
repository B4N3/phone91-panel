...
$qString = (isset($_REQUEST['q']) && $_REQUEST['q']) != ''?$this->db->real_escape_string($_REQUEST['q']):'';
...
<div id="resTrLogWrap" class="commLeftList">
    ...
    <div class="clear inner"> 
        ...
        <div id="resultContainer" class="clear flip-scroll box-"> 
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="resTrnLogTbl" class="cmntbl boxsize" id="accessNumberLogTable">
                    <thead>
                      	<tr>
