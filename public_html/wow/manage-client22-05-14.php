                   ...
                   success:function (text)
                   {
                       var str = '';
                        ...
                        $.each(text,function(key,value){
                          var hrefLocation ='<?php echo $_SERVER['HTTP_HOST']; ?>/controller/signUpController.php?call=loginAs&type=1&userId='+key+'&url='+url.substring(1);
...
function showAllBatchList(){
    ...
    success: function(data){ 
    	...
    	var str = createBulkDesign(data.batchDetail);
         $("#bulkclientList").html('');
