         ...
         <div id="changeSearchType"><span>Select Criteria: </span> 
                  ...
                  <div class="box-widgets country" style="width:1400px;">
                    ...
                    <div id="getRoutecountryDetailsGraphContainer">
                        <iframe id="countryifrm" src="<?php echo PROTOCOL.HOST_NAME;?>/admin/routeCountryLog.php?fromDate=&toDate=&route=<?php echo $routeName;?>" style="width:1400px;height:600px;position: relative;top: 1px;left: 51px;border-width: 0px;"></iframe></div>
...
$.datepicker.setDefaults({changeMonth: true,
  ...
  $('#fromDate').datepicker({onSelect: function() {
    ...
    function getRouteCharts(routeId)
    {
        ...
        //$('#getRoutecountryDetailsGraphContainer').html('<iframe id="countryifrm" src="<?php echo PROTOCOL.HOST_NAME;?>/admin/routeCountryLog.php?fromDate='+fromDate+'&toDate='+toDate+'&route=<?php echo $routeName;?>" style="width:1400px;height:400px;position: relative;top: 1px;left: 51px;border-width: 0px;"></iframe></div>');
        //console.log('<?php echo PROTOCOL.HOST_NAME;?>/admin/routeCountryLog.php?fromDate='+fromDate+'&toDate='+toDate+'&route=<?php echo $routeName;?>');
        $('#countryifrm').attr('src','<?php echo PROTOCOL.HOST_NAME;?>/admin/routeCountryLog.php?fromDate='+fromDate+'&toDate='+toDate+'&route=<?php echo $routeName;?>');
