...
/*window.onerror = function(errorMsg, url, lineNumber) {
	var error = {};
	error.info = 'Error handled by - AY';
	...
	console.log(error);
	$('#progress').width(0);
	var dialog = '<div title="Error" id="gErrorDlg">\
		<div id="gErrorHd">There is some error in <strong>JavaScript</strong>. This page will not work properly. Try (<strong>Ctrl+F5</strong>) or contact your admin </div>\
		<div id="gError">'+errorMsg+', '+url+', Line : '+lineNumber+'</div>\
		</div>'
	$(dialog).dialog({
		//modal:true,
		resizable:false,
...
<div id="header" class="clear">
	 <a href="#menu-left" class="menuLeft"></a><span id="screen" style="position:absolute"></span>
          ...
          <div class="deskMenu  clear">
				...
				?>
				<a id="returnToReseller" class="themeBg" href="<?php echo $protocol.$_SERVER['HTTP_HOST'].'/controller/signUpController.php?call=loginAs&userId='.$_SESSION['mainUser']; ?>" title="Back to admin"><span class="ic-32 ic-back"></span></a>
				<?php } ?>
                <!--Logo Here-->
                <div id="logosec">
             ...
             <div id="usersec" class="pr">
  				  <div class="clear cp"  onclick="uiDrop(this,'#showUsType', 'true')">
   				  ...
   				  <ul class="dropmenu boxsize ln" id="showUsType">
                      ...
                      <li id="resMenuLi" class="UserTypeMenu" menuval="reseller" icId ="rSign" lPage ="#!reseller-manage-clients.php" >Reseller</li>
...
//                                 } 
				...
				<li class="resellerActiveCall"><a class="contact bdrTrns" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>:8082" >Active Call</a></li>
