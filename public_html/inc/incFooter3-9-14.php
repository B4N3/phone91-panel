    ...
    <section id="bottomFooter">
         <section class="innerFooter">         
            ...
            <aside class="box">
		        ...
		        <li>
                        <a href="https://play.google.com/store/apps/details?id=com.zemdialer" target="_blank">
                                Android (Opt Code : 1011)
                        </a>
                  </li>
			<li>
                        <a href="https://itunes.apple.com/in/app/zem-dialer/id651404015?mt=8" target="_blank">
                                IPhone (Opt Code : 1011)
                        </a>
                  </li>
			<li>
                        <a href=downloads/zemplus15.exe target="_blank">
                                Windows PC (Opt Code : 1011)
                        </a>
                  </li>  
			<li>
