...
<div class="wrapper">
   ...
   <header id="header">
       <?php
            ...
            {				
				?>				
				<a id="returnToReseller" class="themeBg" href="<?php echo $_SESSION['protocol'].$_SERVER['HTTP_HOST'].'/controller/signUpController.php?call=loginAs&userId='.$_SESSION['tempVar']['mainUser']; ?>" title="Back to admin"><span class="ic-32 ic-back"></span></a>
	<?php }
               else if(isset($_SESSION['tempVar']['type']) && $_SESSION['tempVar']['type'] == 1){ ?>
              <a id="returnToReseller" class="themeBg" href="<?php echo $_SESSION['protocol'].$_SERVER['HTTP_HOST'].'/controller/signUpController.php?call=loginAs&type=1&userId='.$_SESSION['tempVar']['mainUser']; ?>" title="Back to admin"><span class="ic-32 ic-back"></span></a>                  
        <?php }?>
              <?php if(isset($logoImage) ){ ?>
              <a href="/index.php" title="Phone91"  class="fl"><img src="<?php echo _MANAGE_PATH_.'/'.$logoImage; ?>" alt="Your logo"/></a>
              <?php }else{ ?>
        <a href="/index.php" title="Phone91" id="logo" class="fl"></a>
              <?php } if(_DOMAIN_THEME_ == "voip" || _DOMAIN_THEME_ == "defaultTheme"){?>
