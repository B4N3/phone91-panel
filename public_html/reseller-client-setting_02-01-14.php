        	...
        	<div class="actionDiv">
            	<p class="mrB">Type</p>
                  ...
                  <div class="fields">          
                   ...
                   <div class="dn fields" id="transotherType">
                ...
                <div class="">
<!--                    <input type="text" name="transType" id="transType"/>-->
...
<!--                        <option value="48">GBP</option>-->
                    ...
                    changes: new button added In place of anchor tag.
                    -->
                    <input type="button" class="mrT btn btn-medium btn-primary" name="additionalTrans" id="additionalTrans" value=" ADD " onclick="addAdditionTransaction();"/>
<!--                    <a class="btn btn-mini btn-primary clear alC fl" onclick="addAdditionTransaction();" id ="additionalTrans">
                        <div class="clear tryc tr1 addSpace">
                            <span class="ic-16 add" title="Add"></span>
                        </div>
                    </a>-->
                </div>
            </div>
