...
$funObj->sendErrorMail('ankitpatidar@hostnsoft.com','api details'.print_r($PayPalConfig,1).' dfdf '.print_r($_SESSION['PayPalResult'],1));
...
switch ($action)
{
    case 'process':
    {
        ...
        $Payment = array(
                    ...
                    'notifyurl' => 'https://voip91.com/checkoutResponse.php?action=ipn',  						// URL for receiving Instant Payment Notifications
