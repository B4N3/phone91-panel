...
$str='';
# get csv data 
$str ='INSERT INTO 91_dialPlanRoute_sud ( dialPlanId, userPrefix, routeId ) VALUES ';
...
}Delete FROM `91_dialPlanRoute_sud` WHERE `dialPlanId` LIKE '10' 
*/
?>