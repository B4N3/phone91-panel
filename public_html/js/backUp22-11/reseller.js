...
function prepareRow(jsonData)
{
    ...
    $.each(jsonData, function(i, field){
                    ...
                    str += "<tr class='"+$class+"' id='rowId_"+field.id_tariffs_key+"'>\
                        <td><input class='checkBox' type='checkbox' value='"+field.id_tariffs_key+"'/></td>\
                        <td><input type='hidden' id='idTariffKey_"+field.id_tariffs_key+"' name='idTariffKey_"+field.id_tariffs_key+"' value='"+field.id_tariffs_key+"' /><input type='text' id='prefix_"+field.id_tariffs_key+"' name='prefix_"+field.id_tariffs_key+"' value='"+field.prefix+"'/></td>\
                        <td><input type='text' id='country_"+field.id_tariffs_key+"' name='country_"+field.id_tariffs_key+"' value='"+field.description+"' /></td>\
                        <td><input type='text' id='operator_"+field.id_tariffs_key+"' name='operator_"+field.id_tariffs_key+"' value='"+field.operator+"' /></td>\
                        <td><input type='text' id='rate_"+field.id_tariffs_key+"' name='rate_"+field.id_tariffs_key+"' value='"+field.voiceRate+"' /></td>\
...
function getTariffDetails(tariffId,limit,type)
{
    /*@author : SAMEER RATHOD
            ...
            if(response != null)
            {
                ...
                $.each(response, function(i, field){
                    ...
                    str += "<tr class='"+$class+"' id='rowId_"+field.slNo+"'>\
                            <td><input class='checkBox' type='checkbox' value='"+field.slNo+"'/></td>\
                            <td><input type='hidden' id='idTariffKey_"+field.slNo+"' name='idTariffKey_"+field.slNo+"' value='"+field.slNo+"' /><input type='text' id='prefix_"+field.slNo+"' name='prefix_"+field.slNo+"' value='"+field.prefix+"'/></td>\
                            <td><input type='text' id='country_"+field.slNo+"' name='country_"+field.slNo+"' value='"+field.description+"' /></td>\
                            <td><input type='text' id='operator_"+field.slNo+"' name='operator_"+field.slNo+"' value='"+(field.operator != 'undefined'?field.operator : "")+"' /></td>\
                            <td><input type='text' id='rate_"+field.slNo+"' name='rate_"+field.slNo+"' value='"+field.voiceRate+"' /></td>\
        ...
        success:function(resMsg)
        {
            ...
            if(resMsg != null)
            {
                ...
                $.each(resMsg,function(i,item){
                    ...
                    $('#selPlan').append(option);
//                    $('.callshopsele').html(option);
            }
        }
    })
}
