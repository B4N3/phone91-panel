			...
			success: function(data){
                        //   console.log(data);
                          if(ui.item.value != "No result found."){ 
                           var html ='<div class="oh"><img src="/images/flags/in.png" width="48" height="48" class="fl db dn">\
			...
			success: function(data){
                        ...
                        $.ajax({
                          ...
                          var html ='<div class="oh"><img src="/images/flags/in.png" width="48" height="48" class="fl db">\
                            <div class="fl fs2 imgspace mrL1">Rates for '+term2+'<span class="prices">'+data.currency+'/min</span></div></div>';
                            var count = 0;
