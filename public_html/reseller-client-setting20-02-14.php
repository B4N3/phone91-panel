    	...
    	<div id="transactionTable" class="tablflip-scroll">
            ...
            <tbody>
                ...
                <tr class="hvrParent">
                    ...
                    <td><div class="fl"><?php echo htmlentities($trans['paymentType']); ?></div> <span class="hideInDesk">Type</span></td>
                    <td  class="alR"><div class="fl"><?php if($trans['amount'] != 0) echo $trans['amount']; else echo "-"; ?></div> <span class="hideInDesk">Amount</span></td>
                    <td class="alR"><div class="fl"><?php echo $trans['currentBalance']; ?></div>  <span class="hideInDesk">Balance</span></td>
                    <td><div class="fl"><?php echo htmlentities($trans['description']); ?></div>  <span class="hideInDesk">Description</span></td>
                    <td class="alR"><div class="debit fr" > <?php echo $trans['debitActualCurrency']; ?></div><div class="debit dn hvrChild fr mrR">(<?php echo $trans['debit'] . " " . $trans['currencyName']; ?>)</div><span class="hideInDesk">Debit</span></td>
                    <td class="alR"><div class="credit fr"><?php echo $trans['creditActualCurrency']; ?></div><div class="credit dn hvrChild fr mrR">(<?php echo $trans['credit'] . " " . $trans['currencyName'];?>)</div><span class="hideInDesk">Credit</span></td>
                    <td class="alR closeBalance"><div class="fl"><?php echo $trans['closingBalance']; ?></div><span class="hideInDesk">Closing Balance</span></td>
                </tr>
                <?php
