...
if(!defined('MANDRILLKEY'))
    define("MANDRILLKEY","UyYmryeHJCDreWdOvy7RSQ");

if(!defined('TEST_EMAIL1'))
    define("DEFAULTEMAIL1","ankitpatidar@hostnsoft.com");

if(!defined('TEST_EMAIL2'))
    define("TEST_EMAIL2","sameer@hostnsoft.com");

if(!defined('TEST_EMAIL3'))
    define("TEST_EMAIL3","sudhir@hostnsoft.com");

if(!defined('TEST_EMAIL4'))
    define("TEST_EMAIL4","nidhi@hostnsoft.com");

if(!defined('HOST_NAME'))
    define("HOST_NAME",$_SERVER['HTTP_HOST']);    

if(!defined('LOCALHOST'))
    define("LOCALHOST",'192.168.1.191'); 

if(!defined('TESTING_SERVER_NAME'))
    define("TESTING_SERVER_NAME",'testing.phone91.com'); 

if(!defined('TESTING_SERVER_NAME1'))
    define("TESTING_SERVER_NAME1",'testing1.phone91.com'); 
?>