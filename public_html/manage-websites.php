...
<div class="commHeader">
	<div class="showAtFront">
        <div class="clear" id="srchrow">
        	   <a class="btn btn-medium btn-primary clear alC iconBtn fl slideAndBack" title= "Add New Website" 
...
dynamicPageName('Manage website')
...
function getDomainList()
{
    $.ajax({
        ...
        $.each(response,function(key,item){
            str +='<li class="slideAndBack" class="" id="web_'+item.id+'" onclick="selectedWebLi(\''+item.domainName+'\',event,\''+item.id+'\')">\
				 <div class="jh clear">\
