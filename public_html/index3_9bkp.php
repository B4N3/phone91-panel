...
if(isset($_REQUEST['submit']))
{
	...
	$funobj->login_user($userid,$pwd,$remember_me,$_SERVER['HTTP_HOST']);
	exit();	
}
trigger_error("step 2");
...
{
  trigger_error("loginb:".ROOT_DIR."themes/"._DOMAIN_THEME_."/index.php");
        include_once(ROOT_DIR."/loginb.php");
        exit();
}
else
{
  trigger_error("step 4"._DOMAIN_THEME_.'domain:'._DOMAIN_NAME_);
