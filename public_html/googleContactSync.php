...
//$redirect_uri='https://voice.phone91.com/googleInsertContact.php';//you redirect url
//$client_id='389356668086.apps.googleusercontent.com';//your client id
...
$loginUrl = sprintf("https://accounts.google.com/o/oauth2/auth?scope=%s&state=%s&redirect_uri=%s&response_type=code&client_id=%s&access_type=%s&approval_prompt=%s", $scope, $state, GREDIRECTURL, GCLIENTID, $access_type,$approval_prompt);
