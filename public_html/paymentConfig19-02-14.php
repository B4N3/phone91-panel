...
$returnUrl = $sandbox ? 'https://"'.$_SERVER['HTTP_HOST'].'"/checkoutResponse.php' : 'https://"'.$_SERVER['HTTP_HOST'].'"/checkoutResponse.php';
$cancelUrl = $sandbox ? 'https://"'.$_SERVER['HTTP_HOST'].'"' : 'https://"'.$_SERVER['HTTP_HOST'].'"';
$bussiMail = $sandbox ? 'ankkuboss@paypal.com' : 'payment@walkover.in';
$notifyUrl = $sandbox ? 'https://"'.$_SERVER['HTTP_HOST'].'"/checkoutResponse.php' : 'https://"'.$_SERVER['HTTP_HOST'].'"/checkoutResponse.php';
