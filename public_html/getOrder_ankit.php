...
else
{
    ...
    $SECFields = array(
                                                ...
                                                'returnurl' => 'https://voip91.com/checkoutResponse.php', 							// Required.  URL to which the customer will be returned after returning from PayPal.  2048 char max.
                                                'cancelurl' => 'https://voip91.com', 							// Required.  URL to which the customer will be returned if they cancel payment on PayPal's site.
        ...
        $Payment = array(
                                        ...
                                        'sellerpaypalaccountid' => 'ankkuboss@paypal.com'			// A unique identifier for the merchant.  For parallel payments, this field is required and must contain the Payer ID or the email address of the merchant.
                                        );
