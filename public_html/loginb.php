...
<!--                    <img src="/images/topArrow.jpg" width="18" height="15" alt="" title="" class="pa t r arrow"/>-->
                    <form action="/index.php" method="POST" name="login">
                                ...
                                onblur="(this.value == '') && (this.value = 'Username')" id="loginUserName"  value="<?php echo (isset($_COOKIE['usern']))? $_COOKIE['usern'] : '';?>"/>
                                <input type="password" name="pwd" placeholder="Password"
                                onfocus="(this.value == 'Passaword') && (this.value = '')"
                                onblur="(this.value == '') && (this.value = 'Passaword')" id="loginPassword" value="<?php echo (isset($_COOKIE['passn']))? $_COOKIE['passn'] : '';?>"/>
        ...
        <?php }
            ...
            //header('locatio:/userhome.php#!contact.php');?>
<!--           <a href="/userhome.php#!contact.php" title="My Account" class="macc whBtn" >My Account</a>-->
<script type="text/javascript">window.location.href='/userhome.php#!contact.php';</script>
        <?php }?>	
        <span class="clr"></span>
    </header>
    <!-- //Header -->
