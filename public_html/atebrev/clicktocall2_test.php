...
function c2ccallfile($unique_id1, $unique_id2, $src_no, $des_no, $route){
        ...
        $Data = "Set: PassedInfo=".$unique_id1."-".$unique_id2."\n";
        fwrite($Handle, $Data);
...
$con = $db_obj->voip_connect();
$sql = "insert into 91_currentCalls (uniqueId, id_client, id_chain, callerId, dialed_number, call_dial, status, call_type, id_reseller) VALUES ('$unique_id1', '$id_client', '$chainId', '$des_no', '$src_no', now(), 'DIALING', 'C2C', '$resellerId')";
...
$con = $db_obj->voip_connect();
$sql = "insert into 91_currentCalls (uniqueId, id_client, id_chain, callerId, dialed_number, call_dial, status, call_type, id_reseller) VALUES ('$unique_id2', '$id_client', '$chainId', '$src_no', '$des_no', now(), 'WAITING', 'C2C', '$resellerId')";
$result = mysql_query($sql,$con) or $error = mysql_error();
mysql_close($con);
...
$call_status = c2ccallfile($unique_id1, $unique_id2, $newExten, $des_no, $routeName);
