...
if($openid->validate())
{
    ...
    logmonitor("phone91-google", $signup_obj->check_user_avail($email));
    
    
    if($signup_obj->check_user_avail($email))
    {      
        ...
        if($resultArr['status'] == 'success')
        {
            ...
            {
                $userDetail = base64_encode(base64_encode(json_encode( array( base64_encode(base64_encode($signup_obj->newUserId))))));
