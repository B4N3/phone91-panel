...
$transaction = $trans_obj->getPersonalTransaction($userId,1); // 1 for get reseller transaction log 
                      ...
                      <?php $totalCredit=0;$totalDebit=0;
                            foreach($transData as $detail){ ?>
                              ...
                              <tr class="">
                                        ...
                                        <td class="alR" onMouseOver="$(this).find('span').show();" onMouseOut="$(this).find('span').hide();"><span class="debit dn">(<?php echo $detail['debit'] . " " . $detail['currencyName']; ?>)</span><p class="debit" > <?php echo $detail['debitActualCurrency']; ?></p></td>
                                        <td class="alR" onMouseOver="$(this).find('span').show();" onMouseOut="$(this).find('span').hide();"><span class="dn">(<?php echo $detail['credit'] . " " . $detail['currencyName'];?>)</span><?php echo $detail['creditActualCurrency']; ?></td>
