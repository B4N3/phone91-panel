	...
	<div class="showAtFront">
		...
		<div class="fl" id="srchrow">
			<div id="userType" class="fl">
				<input type="radio" id="single" name="radio" checked="checked"><label for="single" onclick="changeClient('single');">Single</label>
				<input type="radio" id="batch" name="radio"><label for="batch" onclick="changeClient('batch');">Batch</label>				
			</div>		
	...
	<div id="leftsec" class="slideLeft commLeftSec">
		...
		<?php  if($clientDetails["blockUnblockStatus"] != 1){
			...
			<?php foreach($bulkData as $bulkUserDetail){?>
                                <li class="group" onclick="window.location.href='#!reseller-manage-clients.php|batchname.php?batchId=<?php echo $bulkUserDetail["batchId"];?>'">
                                        <div class="uiwrp cp">
       ...
       $.each(data,function(key,value)
        {
            ...
            str +='<li class="group" onclick="window.location.href=\'#!reseller-manage-clients.php|batchname.php?batchId='+value.batchId+'\'">\
                    <div class="uiwrp cp">\
                      <i class="ic-16 notif notifyBatch"></i>\
