...
//        $userName = $row['userName'];
    ...
    function getAcmInfo($acmId)
    {
        ...
        #access password by database of the current account manager
        $this->db->select('deleted,admin,email,number,cCode,fullName,AES_DECRYPT(password,"'.ENCRYPT_KEY.'") as password,userName,acmId')->from($table)->where("acmId = " . $acmId . "");
