...
//        $this->sendErrorMail("sameer@hostnsoft.com", "Phone91 signup_class personal info table query fail : $qur ");
      ...
      $beforeLoginFlag = 0;
      ($resellerSetting['mobile'] == 1? $beforeLoginFlag = 1 : $beforeLoginFlag = 0);
...
//         $this->sendErrorMail("rahul@hostnsoft.com", "Phone91 signup_class 91_userBalance query fail : $tempsql ");
    ...
    public function signUp($parm)
    {
      ...
      $resellerId = $parm['reseller_id'] = $this->getDomainResellerId();
  ...
  /********************END HERE*****************************************************/   
    ...
    $createUserResult = $this->createUser($parm, $tariffId, 0, $currencyId);
        ...
        {
            $this->login_user($this->userName,$this->password,0,$parm['domain'],1);
        }
        else        
    ...
    public function saveMobileNumber($request,$userId,$type)
    {
        ...
        $this->domainResellerId = $this->getDomainResellerId();
    ...
    protected function sendSmsAndCall($carrierType) {
          ...
          $this->userName = $this->getUserUName($this->userId);
...
//       }
  ...
  /********************END HERE*****************************************************/   
    ...
    function signupTransactionOld($reseller_id,$userid,$balance){
...
//        $transaction_obj->updateUserBalance($userid,$currentBalance);
    ...
    function signupTransaction($resellerId,$userId,$balance){
        ...
        $transactionObj->toUser = $userId;
         ...
         $msg = $transactionObj->addTransactional_sub($balance,$balance,"signUp",0,0,0,"Sign Up Transaction");
