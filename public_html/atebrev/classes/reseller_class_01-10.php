 ...
 * @since 03-08-2013
 * @package Phone91
 * @details class use for reseller panel 
 */
...
class reseller_class extends fun {
    ...
    # function use for check batch status is block or unblock 
...
//        }
    ...
    #created by sudhir pandey (sudhir@hostnsoft.com)
    #creation date 16-09-2013
    #function use for change user status (block or unblock) with all chain user  OR set Delete Flag of user 
    # parm : type use for either isBlock or deleteFlag both are column name of userLogin table 
    ...
    #created by sudhir pandey (sudhir@hostnsoft.com)
    #creation date 16-09-2013
    #function use for block  user batch (all client of given batch id) OR set Batch Delete flage
    # parm : type use for either isBlock or deleteFlag both are column name of userLogin table 
