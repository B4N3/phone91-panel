...
class websiteClass {
   ...
   function addAboutData($param,$userId){
    ...
    $updateData = array('domainId' => $param['domainId'],
                        "aboutKeyword"=>$param['aboutKeyword'],
                        "aboutDescription"=>$param['aboutDescription'],
                        "bannerStatus"=>$bannerStatus,
                        "bannerDetail"=>array("bannerHeading"=>$param['bannerHeading'],
                                              "bannerSubHead"=>$param['bannerSubHead'],
   ...
   function addContacPageData($param,$userId){
    ...
    #update data array
    $updateData = array('domainId' => $param['domainId'],"contactKeyword"=>$param['contactKeyword'],"contactDescription"=>$param['contactDescription'],"cntbannerStatus"=>$cntBnrStatus,"cntbannerDetail"=>array("contactHeading"=>$param['contactHeading'],"contactSubHeading"=>$param['contactSubHeading'],"contactBtnText"=>$param['contactBtnText'],"contactBtnLink"=>$param['contactBtnLink']),"contactFormStatus"=>$contactFormStatus,"contactFormEmail"=>$param['contactFormEmail'],"mapLocationStatus"=>$mapLocationStatus,"gMapEmbededCode"=>$param['gMapEmbededCode']);
   ...
   function addPricingData($param,$userId){
    ...
    #update data array
    $updateData = array('domainId' => $param['domainId'],"pricingKeyword"=>$param['pricingKeyword'],"pricingDescription"=>$param['pricingDescription'],"tariffPlan"=>$param['tariffPlan'],"bankDetail"=>$detail);
   ...
   function getFileData($fileName) {
    $url = '10.42.43.174/manageWebsiteImage/'.$fileName;
    $ch = curl_init();    
