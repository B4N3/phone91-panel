...
class pin_class extends fun
{
	...
	function getPinDetails($batchid,$userid,$pageNo = 1,$export = 0)
	{
        ...
        function searchBatch($parm,$userid)
        {
            ...
            if(isset($parm['data']))
            {
                ...
                {
                     $condition = "userId = " . $userid . " and batchName like '%".$parm['data']."%' ORDER BY batchId DESC ";
                }
                else 
             ...
             //return $batch;
             return json_encode(array("batch"=>$batch,"userName"=>$userName,'pages' => $pages));
         }
	...
	function getMyPin($userId,$pageNo=1)
	{
