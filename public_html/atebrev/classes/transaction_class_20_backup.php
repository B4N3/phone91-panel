...
'.$commonMsg;
   ...
   /**
    ...
    function checkTransactionValidation($parm)
    {
        ...
        {
           return json_encode(array("status"=>"error","msg"=>"Description must not contain any special characters other than '@','_','-'"));
        }
    ...
    function addReduceTransaction($parm,$userid,$type)
    {
        ...
        {
          return json_encode(array("status" => "error", "msg" => "You are not authorized to add transaction."));
        }
