   ...
   ++$last;
    ...
    function sign_up($parm){
     ...
     #check for all value inserted or not in signup form    
      ...
      $data=array("userId"=>(int)$userid,"userName"=>$parm['username'],"password"=>$parm['password'],"isBlocked"=>$blockUnblockStatus,"deleteFlag"=>$deleteFlag,"type"=>(int)$parm['client_type']); 
