...
<div id="rightsec" class="cntRight hidden-tablet ">
	   <h2 class="h2 fwN mrB2">You can also call via</h2>
		<p class="viamsg"></p>
		<div class="box-sync">
	        <h3 class="h3 fwN mrB1">Call via Dialers</h3>			
			<p>Download "Mosip" or "Zemp" dialers.</p>
            <ol class="howPoints">
            <li>1. Enter brand PIN or Opt in code: 1011</li>
            <li>2. Enter your username and password to register.</li>
            </ol>
