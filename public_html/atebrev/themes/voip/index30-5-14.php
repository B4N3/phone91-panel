...
<title>Make VoIP International Call at Lowest Price via Gtalk, Mobile & PC Dialer - Phone91</title>
...
<meta name="description" content="Make a low rate VoIP calls to India, Pakistan and Bangladesh from Gtalk, Android, iPhone & Laptop/PC. Best quality route and 100% working in UAE, signup now to get free credit." />
	    ...
	    <section id="featuresWrap">
	    	...
	    	<section class="wrapper pr">        	
	            ...
	            <div class="searchFields fl col2">
	               ...
	               <h1>100% working in UAE</h1>

                   <h2>By ZemPlus and MoSIP Dialer (Opt Code : 1011)</h2>
	               ...
	               <form method="POST" action="action_layer.php?action=signup" id="signupForm" onsubmit="return register();">
                   	...
                   	<div class="fields">
                            ...
                            <input type="text" id="username"   name="username" value=""  autocomplete="off" onblur="check_user_exist()"  placeholder="Choose Username" />
	              ...
	              <div class="fields">
                    ...
                    <input type="password" id="password"  name="password" value="" placeholder="Password"  autocomplete="off" onblur="check_password_strength();"/>
                  ...
                  <div class="fields">
                      	...
                      	<input type="submit" title="Get Started and Create my Account" value="Sign Up - First Few Call Free" name="submit" class="rdbtn"/>
             ...
             <div id="stcnt">             	
                ...
                <aside class="national">
                  ...
                  <div class="fl f10 ">
                    ...
                    <span class="grayClr2 db">2.11<span class="fs4">cents/min</span></span>
            	...
            	<aside class="national">
                 ...
                 <div class="fl f10">
                    ...
                    <span class="grayClr2 db">13.62 <span class="fs4">cents/min</span></span>
                ...
                <aside class="national">
                  ...
                  <div class="fl  f10">
                    ...
                    <a href="javascript:void(0)" class="db" id='pk'>USA</a>                    

                    <span class="clr"></span>

                    <span class="grayClr2 db">3.18<span class="fs4">cents/min</span></span>
