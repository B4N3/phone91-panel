...
<div class="wrapper">
   ...
   <header id="header">
        ...
        <nav class="fl openRegu f16">
            <a class="thmClr" href="themes/<? echo _DOMAIN_THEME_; ?>/index.php" title="Home" id="home">Home</a>
                <a class="" href="themes/<? echo _DOMAIN_THEME_; ?>/voipcall/how-it-works-gtalk.php" title="How it works"  id="works">How it works</a>
                <a href="themes/<? echo _DOMAIN_THEME_; ?>/voipcall/pricing.php" title="Pricing"  id="pricing">Pricing</a>
