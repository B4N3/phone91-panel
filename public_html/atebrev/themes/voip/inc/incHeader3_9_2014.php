...
<div class="wrapper">
   ...
   <header id="header">
        ...
        <div id="resMenu" class="dn">
            <button onclick="js.uiDrop(this, '#rmItem', true)"><span>≡</span>Menu</button>
            <ul id="rmItem" class="dn">
                <li><a class="thmClr" href="/index.php" title="Home" id="home">Home</a></li>
                <li><a class="" href="/voipcall/how-it-works-gtalk.php" title="How it works"  id="works">How it works</a></li>
                <li><a href="/voipcall/pricing.php" title="Pricing" id="pricing">Pricing</a></li>
                <li><a class="last" href="/reseller.php" title="reseller" id="reseller">Reseller</a></li>                 
            </ul>
        </div>
        <?php
        ...
        <?php if(isset($_SESSION['error'])){
         ...
         <aside class="rightsecNav f16 fr">
            <div style="position:relative">
                ...
                <a id="login" class="btn" href="javascript:void(0)" onclick="js.uiDrop(this, '#popwrap', true)" title="Login">Login</a>
...
<!--                                <p class="taC or">Or</p>
        ...
        <?php }
         ...
         <?php }
                ...
                { ?>
                   <a href="/userhome.php#!contact.php" title="My Account" class="whBtn fr" >My Account</a>
