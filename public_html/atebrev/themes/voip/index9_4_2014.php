	    ...
	    <section id="featuresWrap">
	    	<section class="wrapper pr">        	
	            <div class="searchFields fl col2">
                   ...
                   <h2>Call by Google talk and Zem Dialer or MOSIP (Code/Pin : 1011)</h2>
                  ...
                  <div class="fields">
	                    <input type="email" id="email"  value="" name="email" placeholder="Email Id" onblur="check_email_exist()"/>
                        <div class="msg pa"></div>
                  </div>
                  
                  <div class="fields">
                      	<input type="submit" title="Sign Up - First few calls free" value="Sign Up - First Few Calls Free" name="submit" class="rdbtn"/>
                    </div>
             ...
             <div id="stcnt">             	
                ...
                <aside class="national">
                  ...
                  <div class="fl f10 ">
                    ...
                    <span class="clr"></span>
                    <span class="grayClr2 db">0.92 <span class="fs4">cents/min</span></span>
                  </div>
                </aside> 
                </div>
