$(document).ready(function(){
    ...
    check_user_exist =function()						
    {
		...
		{ 
			...
			if(msg == 1)
			{
				$("#username").next().removeClass("error_red").addClass("error_green").html("You can choose this username. Available");	
...
//             return false;
     ...
     if(responseText.msg=='Successfully Register Password send to mobile.')
     {
