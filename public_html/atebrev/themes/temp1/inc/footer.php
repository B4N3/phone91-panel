        ...
        <div id="fleft">
          <div id="feedback">
            ...
            <form id="feedbak" action="" method="post">
                  ...
                  <input  id="quickmsgsmt" type="button" name="submit_feedbak" class="small blue awesome" value="Submit" onclick="feedback_submit()"/>
            </form>
          </div>
        </div>
        <div id="fright">
          <div id="contact">
            <h4>Contact Us</h4>
<!--            <li>
              <p><strong>GTalk ID</strong>: support@phone91.com</p>
            </li>-->
            <li>
              <p><strong>Mail</strong>: <?php echo _CONTACT_EMAIL_; ?></p>
            </li>
            <br />
          </div>
          <div id="followus">
            ...
            <ul>
              ...
              <div class="clf"></div>
              <div class="fb-like" data-href="<?php echo _FB_LINK_; ?>" data-send="true" data-width="250" data-show-faces="true" data-font="verdana"></div>
            </ul>
          </div>
        </div>
        <div id="fmiddle">
          ...
          <ul>
            <li>
              <h5><a href="<?php echo _GPLUS_LINK_; ?>">Google <img src="/images/gtalk.png" /></a></h5>
            </li>
          </ul>
        </div>
    	<div class="clf"></div>
...
<ul class="ln social-icon-wrap scicons">
      <li class="sc twit"> <a target="_blank" href="<?php echo _TWITTER_LINK_; ?>">Twitter</a> </li>
      <li class="sc fb"> <a target="_blank" href="<?php echo _FB_LINK_; ?>">Facebook</a> </li>
      <li class="sc in"> <a target="_blank" href="<?php echo _LINKEDIN_LINK_; ?>">Linkedin</a> </li>
<!--      <li class="sc yt"> <a target="_blank" href="http://youtu.be/VG2OnN_mMVo">Youtube</a> </li>-->
      <li class="sc mail"> <a href="<?php echo _CONTACT_EMAIL_; ?>">Mail</a> </li>
</ul>
