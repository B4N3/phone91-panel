...
<div id="batchWrap">
    ...
    <div id="tabs">
        ...
        <div id="tabs-3" class="tabs">
        	<div id="rightwrap" style="margin-left:15px;">
                <form id="editBatchDetailform">
                    ...
                    <div class="fields">
                        <label>Batch Expiry</label>
                         <input type="text" id="batchExpiry"  name="batchExpiry" value="<?php echo $batchData['expiryDate']; ?>" />
                    </div>
             ...
             <div class="fr">
                <input style="width:120px" id="deleteBatch" type="button" title="Delete" value="" class="btn btn-danger" onclick="">
             </div>
...
var str = '<table width="100%" cellspacing="0" cellpadding="0" border="0" class="cmntbl  boxsize" id="batchTrstable">\
                <thead>\
                    <tr>\
                        <th width="10%">Date</th>\
                        <th width="10%">Type</th>\
                        <th width="5%" class="alR">Talktime</th>\
