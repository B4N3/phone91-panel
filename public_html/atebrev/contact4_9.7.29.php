...
<div id="leftsec" class="cntLeft slideLeft">
	...
	<div class="innerSection mrB4">
		<a class="btn btn-medium btn-blue" href="javascript:void(0);" id="addNewCnt">
        Add Contact
		</a>
        <a class="btn btn-medium btn-inverse" href="javascript:void(0);" id="importCnt">
        Import Contacts
		</a>
...
<!--Right Section-->
<div id="tabs" class="slideRight commRightSec">
    ...
    <ul>	
        ...
        <li onclick="sipRegister();"><a href="#tabs-3"><i class="ic-32 oc"></i><span>Web Calling</span></a></li>
        <li onclick="setDefaultFlageByIp('twoWay');"><a href="#tabs-4"><i class="ic-32 tc"></i><span>Two-way Calling</span></a></li>
    ...
    <div>
        <div id="tabs-2" class="tabs">
            ...
            <div class="mrT2">
                ...
                <p class="f14 ligt ddLit mrT">Download Phone91 mobile application in from Itunes or Google play store to <b>make calls directly from your mobile.</b><br> 
Mobile application comes handy when you don't want to use many options and make instant calls. </p>
    ...
    <div>
        <div id="tabs-4" class="tabs">            
            ...
            <div id="twCallBox" class="clear callCont">
                <div class="twBox mrB2">
				 ...
				 <input name='code' type="text" id="codeSource" class="min defaultCode_twoWay" value="91" readonly/>
                                    <input class="pr contact fl" id="source" type="text"/>
                    ...
                    <div class="statCnt mrT4 callEnd">
                        ...
                        <div class="statBox">
                            ...
                            <h3 class="time" id="timeFrom">00:00</h3>
                        </div>   
                    </div>
                </div>
                <div class="twBox">
                    ...
                    <div class="countryWrap">
                         <div class="selwrpa">
                                ...
                                <ul id="flaglistDest" class="bgW" style="display: none;">
                                   <?php 
                             ...
                             <div class="codeInput">
                                    ...
                                    <input class="pr contact fl" id="dest" onkeyup="callcostKeyup();" type="text" />
                             </div>
                    </div>
                    <div class="statCnt mrT4 callEnd">
                    	<div class="statLin"></div>
                        <div class="statBox">
                            ...
                            <h3 class="time" id="timeTo">00:00</h3>
                        </div>   
                    </div>
                </div>
            ...
            <!--recent calls-->
            <div id="recentCallsWrp" class="mrT2 pdT2 bdrT dn"></div>
    ...
    $.ajax({
        ...
        success:function(msg)
        {
            ...
            $.each(msg,function(key,value){
				...
				str +='<h4 class="f15" id="recentCallHead" >Recent Calls</h4>\
				...
				<li class="clear">\
					...
					<div>\
                        <div class="recall">\
                            <a class="btn btn-medium btn-blue mrT" href="javascript:void(0);">\
                                <div class="tryc">\
			...
			else
				{
					str+='<h4 class="f15" id="recentCallHead">Recent Calls</h4>\
					<ul class="recCallList ln mrB2" id="recentCallUl">\
					<li class="pd1"><p>Oops..! No recent calls for two way calling.</p></li></ul>';
					$('#recentCallsWrp').html(str);
				}
        }
