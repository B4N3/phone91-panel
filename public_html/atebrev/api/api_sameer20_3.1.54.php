        ...
        public function sendMesages()   
        {
            ...
            {  
               ...
               else
               {
                   $this->funobj->SendSMSUSDnew($tempparam);
                   $error[RESPONSE] = "0";
                   $error[MESSAGE] = array("code"=>"139","message"=>$callingcardResp['message']);
                   $this->response($this->json($error), 200);
               }
            }
            else
            {
                ...
                {
                    $tempparam['text'] = 'Hey there, follow the below instructions to try our help. 1. To check balance: SMS ‘bal’ to 12028038240
                ...
                if(!empty($userInfo['userInfo']['userId']))
                {
                   ...
                   if(in_array( $message , $messageArray ))
                   {
                     ...
                     // $tempparam['text'] = "hello, Your Account balance is ".round($response['balance'],2).' '.$currency.'';
                      $tempparam['text'] = 'Hey there, your account balance is '.round($response['balance'],2).'.For more such shortcuts, you can always SMS ‘Help’ to 12028038240.Happy sharing!Team Phone91';
