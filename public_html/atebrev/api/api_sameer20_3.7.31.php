        ...
        function getUserPin($fromUser,$toUser,$tempparam,$message = NULL)
        {
            ...
            if(!empty($userInfo['userInfo']['userId']))
            {
               ...
               if(in_array( $message , $messageArray ))
               {
                 ...
                 $error[RESPONSE] = "1";
                 $error[MESSAGE] = array("code"=>"140","message"=>"Balance Information successfully sent to ".$fromUser);
                 $this->response($this->json($error), 200);
               ...
               else 
               {
                    ...
                    if($userInfornation)
                    {
                        if($userInfornation['userPin'])
                        {
                            ...
                            $error[RESPONSE] = "1";
                            $error[MESSAGE] = array("code"=>"140","message"=>"Pin successfully sent to ".$fromUser);
                            $this->response($this->json($error), 200);
