	...
	private function json($data) {
        ...
        */
        ...
        {    
            ...
            $param['userId'] = $this->getUserId( $param['senderNo']);
            ...
            if(isset($contactArray['accessNo']) && !empty($contactArray['accessNo']))
            {
                ...
                {
                    $tempparam['text'] = "Hello, Your access Number for this destination is ".$contactArray['accessNo'];               
                    $this->funobj->SendSMSUSDnew($tempparam);
                ...
                $response = 0;
                $message = "User already have an access number."; 
            }
            else 
            {
               ...
               $allAccessNoArr = $phoneObj->allAccessNo();
                ...
                if(!empty($result))
                {
                    ...
                    $tempparam['text'] = "Hello, Your access Number for this destination is ".$result[0];
                    $this->funobj->SendSMSUSDnew($tempparam);
