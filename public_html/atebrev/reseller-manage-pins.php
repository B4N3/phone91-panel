...
<div class="commHeader">
	<div class="showAtFront">            
            <a title="Add PINns" id="addPins" class="btn btn-medium btn-primary alC iconBtn fl mrR1 slideAndBack" onclick="PinDetailUrl();">
				<span class="ic-24 addW"></span>
				<span class="iconBtnLbl">Add PINs</span>
		</a>
         <div class="fl" id="srchrow">
		 	<input type="text" name="searchBatch" id="searchBatch" placeholder="search" onkeyup="advancePinSearch(this)" class="searchPins"/>
             <!--<label>
	...
	<div class="showAtBack">
		<!-- <a id="editBatch" href="javascript:$('.mm-page').animate({scrollTop:$('#editBatchform').offset().top},'slow');" class="btn btn-medium btn-primary hidden-desktop fr" title="Back">Edit Batch</a>
				...
				<ul class="ln cmnli-mngpin pinlist commLeftList" id='batchPin'>
					...
					<li class="slideAndBack" id="pinLi<?php echo $pinDetails['id'];?>" onclick="showPinDetail(this,event);" batchid="<?php echo $pinDetails['id'];?>" >
					 ...
					 <li class="">
					    <div class="mpinrow clear">
						<p>		
						    <span class="ellp"></span>
						    </p>
						    <h3 class="ellp"><?php echo $notFound;?></h3>
					    </div>
					</li>
					 <?php
					}
...
function batchlistDesign(data)
{
    ...
    {
	str+="<li class=''>\
		<div class='mpinrow clear'><p>\
		<span class='ellp'></span>\
		    </p>\
				<h3 class='ellp'>Pin Not Found</h3>\
		</div>\
	</li>";
