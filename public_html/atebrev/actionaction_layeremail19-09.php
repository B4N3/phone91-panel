...
<div class="setContainer">
    		<a class="btn  btn-primary btn-medium clear alC phoneaddNo email" href="javascript:void(0)" title="Add E-mail">
   ...
   <div class="leftPhone fixed fl mrR1">
            	<ul class="ln" id="emailIdsList">
        <?php 
