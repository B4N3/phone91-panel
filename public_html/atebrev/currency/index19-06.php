...
$amount = (isset($_REQUEST['amount']) && $_REQUEST['amount']) ? $_REQUEST['amount'] : 1;
...
//function currencyAmount($from,$to,$amount){
//   #models object
//   $conn = new models;
//    
//    #collection name 
...
//$from="INR";
//$to="USD";
//$inrToUSd = convertCurr($from,$to);
//
//#AD to inr 
//$from="AED";
//$to="USD";
//$aedToUsd = convertCurr($from,$to);
//
//#Euro to inr 
//$from="EURO";
//$to="USD";
//$euroToUSD = convertCurr($from,$to);
//
//echo $date ."</br>";
//echo "1 INR = ".$inrToUSd." USD </br>";
//echo "1 INR = ".$aedToUsd." AUD </br>";
//echo "1 INR = ".$euroToUSD." EURO </br>";
#created by sudhir pandey (sudhir@hostnsoft.com)
#creation date 02/07/2013
#function use for find currency amount of given currency code and amount 
