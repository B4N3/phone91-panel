...
function callfile_local($mobile_no,$vcode,$uid,$route,$callednumber){
            $dir = "/tmp";
            $File = $route.$uid.".call";
            $path = $dir."/".$File;
        ...
        if (!$Handle){
            ...
            $Data = "Set: PassedInfo=".$uid."-".$callednumber."\n";
            fwrite($Handle, $Data);
...
$call_status = callfile_local($mobile_no,$vcode,$uid,$route,$callednumber);
