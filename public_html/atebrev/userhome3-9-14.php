...
$domianName = explode(".",$_SERVER['HTTP_HOST']);
?>
<!DOCTYPE HTML>
<html>
    <head>
...
if( $_SESSION['res_id'] != 2){ ?>
    <title><?php echo $domianName[0]; ?> My Panel</title>
<?php }else {?>
...
<div id="header" class="clear">
	 <a href="#menu-left" class="menuLeft"></a><span id="screen" style="position:absolute"></span>
          ...
          <div class="deskMenu  clear">
                ...
                <!--Logo Here-->
                <div id="logosec">
               		 <a href="/index.php"><img src="<?php echo ((isset($logoImage) && $logoImage != '')? $logoImage :((($_SERVER['HTTP_HOST'] == "voice.phone91.com")||($_SERVER['HTTP_HOST'] == "voip91.biz"))?'images/phone91-logo.png':$domianName[0])) ?>" height="46px" alt="<?php echo $domianName[0]; ?>" /></a>
               </div>
       		  <!--//Logo Here-->
             <!--User Menus-->
...
//                                 } 
                ...
                <li class="resellerActiveCall"><a class="contact bdrTrns" href="#!reseller-active-call.php"  >Active Call</a><span id="activeCallCounter">0</span></li>
        ...
        <!--Top Right-->
         <ul id="topRightAct" class="ln topmenu">
                ...
                <li class="bdrTrns balance">
					  ...
					  <a class="themeLink clrTrns" href="#!setting.php|panel-pricing.php" >Pricing</a><span class="mrL mrR">|</span>
             <?php if(isset($_SESSION['client_type']) && $_SESSION['client_type'] != 4)
       { ?>   
            <a class="themeLink clrTrns" href="#!setting.php|buymore.php" >Buy Now</a><span class="mrL mrR">|</span>
            <?php } ?>
            <a class="themeLink clrTrns" href="#!transactions.php" >Transactions</a> 
					  </div>
