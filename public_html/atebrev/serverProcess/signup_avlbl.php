...
if(isset($_REQUEST['username']) && isset($_REQUEST['check_avail']))
{
...
//to check if userid existes or not
	...
	$query="insert into clientsshared(login,password,type,id_tariff,account_state,tech_prefix,id_reseller,type2,type3,id_intrastate_tariff,id_currency,codecs,primary_codec) values('$username','$pwd',3277331,'292',0.2000,'SD:;ST:;DP:;TP:;CP:;SC:','209',3,0,-1,'1',15,4)";
