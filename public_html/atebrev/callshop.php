...
<form id="add-Cshop" class="dn" title="Add New Call Shop" method="post" action="" >
	...
	<div class="fields">
        ...
        <div class="fields">
            <input type="checkbox" name="callRecordStatus" id="callRecordStatus" value="1"> Call Record
        </div>
    
	<input type="submit" class="btn btn-medium btn-primary nrmLspace" value="Add" />
...
//    console.log("response".response);
    if(response == null || response==undefined || response=="" || response.length < 1 || response.status == "error")
    {
         str += '<li id="callShopLi_NoData" class="group callShopLi slideAndBack"">\
                                  <h3 class="ellp font15"> No records</h3>\
                              </li>';
    }else{
        ...
        console.log(value.name);
                        ...
                        str += '<li id="callShopLi_'+value.userId+'" class="group callShopLi slideAndBack" onclick="callShopLiFunction('+value.userId+',$(this),event)">\
                                  <h3 class="ellp font15">\
                                     ...
                                     <div class="detailCall">\
                                                <p class="planName">'+value.planName+'</p>\
...
$(function() {
	$('#addnewcallshop').click(function(){
      ...
      //  $('#searchUser').quicksearch('#shopList li');
