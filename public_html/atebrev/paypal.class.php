...
class paypal_class {
   ...
   function validate_ipn() {
      ...
      //include transaction file and create object
      include_once('sendmail.php');
      $sesObj = new MailAndErrorHandler();
      ...
      $sesObj->sendmail_mandrill(array('AnkitPatidar@hostnsoft.com'),'Phone91 Report enter in ipn1',print_r($_POST,1),$from);
      ...
      $sesObj->sendmail_mandrill(array('AnkitPatidar@hostnsoft.com','shubh124421@gmail.com'),'Phone91 Report enter in ipn2,check for verified:',print_r($this->ipn_response,1),$from);
