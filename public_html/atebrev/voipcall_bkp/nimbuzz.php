...
<p>Latest version of Nimbuzz can be downloaded from the below link: <strong> <a href="http://www.nimbuzz.com/en/get/voip-and-chat-on-mobile">Dwonload Link
</a></strong></p>

<br />
<h2 class="subHead">Nimbuzz settings for VOIP calling:</h2>
...
<div class="talkStp">
	...
	<div class="talkDtels"> 
	    <strong>Step 8</strong>
		  <div  class="impSt"></div>
          	<p>Now add a new contact by typing phone@phone91.com in "Enter your friend's username" option and then hit <strong>"Add to contacts"</strong> </p>
		</div>
</div>
