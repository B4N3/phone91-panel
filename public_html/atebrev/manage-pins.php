...
$batchPinjson = $pinobj->getPinDetails($batchid,$userid,$pageNo);
...
<div id="manage-pin-wrap" class="clear">
    ...
    <div id="leftwrap">
        ...
        <div class="clear srchrowSec">
                    <h3 class="h3wico clear">
                             <span class="fl"><span class="hideInTablet">Manage</span> <?php echo $batchDetails['batch_name']?></span> 
          		  </h3>
                <div class="sett pr">
        ...
        <p class="batchInfo mrB2 clear">
                ...
                <span>Expiry <?php echo $batchDetails['expire_date']; ?></span>
        </p>
        
        <a class="btn btn-medium btn-primary clear alC" target="_blank" href="/action_layer.php?action=exportPinList&batchId=<?php echo $batchid; ?>&type=csv" title="Export CSV">Export CSV</a>
        <a class="btn btn-medium btn-primary clear alC" target="_blank" href="/action_layer.php?action=exportPinList&batchId=<?php echo $batchid; ?>&type=xlsx" title="Export xlsx">Export xlsx</a>
	...
	<div id="rightwrap">
        ...
        <?php } ?>
         ...
         <div class="fields">
             <?php if($batchDetails['listenTime'] == 1){
                 ...
                 ?>
                        ...
                        <input type="checkbox" name="listenRemainingTime" id="listenRemainingTime" <?php echo $checked; ?>/>
...
function deleteBatchPin(ths)
{
    ...
    if(confirm('Are You Sure? You want to Delete this pin batch!!!'))
   {
        $.ajax({
