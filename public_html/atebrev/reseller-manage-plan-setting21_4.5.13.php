        ...
        <table border="0" cellspacing="0" cellpadding="0" id="" class="cmntbl boxsize mrT1">
            <thead>
                <tr>
                    ...
                    <th><input type="text" value="" placeholder="Country Code" onkeyup="searchTariff($(this),0)" style="width:100px" /></th>
                    <th><input type="text" value="" placeholder="Country Name" onkeyup="searchTariff($(this),0)"/></th>
                    <th>Operator</th>
