    ...
    public function forgotPassword($userName,$smsCall ,$countryCode = NULL)
    {
        ...
        else
        {
           ...
           else
           {
               ...
               logmonitor('phone91-nidhi' , ' query '.$this->querry.'   '.$smsCall.'  //   //  '  );
               $resellerIdServer = $fetchServerResult['resellerId'];
        ...
        logmonitor('nidhiPhone91Testing' , ' QUERY '.$this->querry);
...
//                else
            ...
            {
                $verifiedNumberRes = array();
                while($numberArr = $resultVerSel->fetch_array(MYSQLI_ASSOC))
                {   
                    $resellerName = $this->getUserNametest($numberArr['resellerId'] , 1);
                    $userName = $this->getUserNametest($numberArr[$userIdField] , 1); 
                    ...
                    $verifiedNumberRes[] = array( 'number' => $fieldValue , 'resellerId' => $numberArr['resellerId'] , 'userId' =>$numberArr[$userIdField] , 'resellerName' => $resellerName , "userName" =>  $userName );
                    $verifiedNumberResArr[] = $numberArr['countryCode']."-". $numberArr['verifiedNumber'];
                    $mobileNumber =  $numberArr['countryCode']. $numberArr['verifiedNumber'];
                }
                 $responseArr['mobileNumber'] = $mobileNumber;
                $responseArr['userDetail'] = $verifiedNumberRes;
                $responseArr['type'] = "2";
                $responseArr['id'] = $userId;
                $responseArr['contact'] = $verifiedNumberResArr;
                $responseArr['status'] = 'success';
    ...
    function getUserNametest($userName , $type = '0')
    {
