$(document).ready(function(){
    ...
    check_user_exist =function()						
    {
	    ...
	    {
		$("#username").next().addClass("error_red").html("Username Must Contain 5 character");						$("#username").addClass("error_red");
		$("#username").focus();
	    }
	...
	if(emailReg.test(u)) 		
	{
	    ...
	    { 
		    ...
		    if(msg==1)
		    {
			    $("#email").next().addClass("error_green").html("You can register with ths email. Available");	
	...
	{
		$("#email").next().addClass("error_red").html("Please enter a proper email id");						$("#username").addClass("error_red");
		$("#email").focus();
	}
    }
	...
	if(u == '' || u.length<7)
	{
	    $("#password").next().addClass("error_red").html("Please enter valid password Must be 7 Character Long");						$("#username").addClass("error_red");
	    $("#password").focus();
	}
	else
	{
	    $("#password").next().addClass("error_green").html("You can use this password");						$("#username").addClass("error_red");
...
// wait for the DOM to be loaded 
 ...
 { 
     ...
     if(responseText.msg =='This User name already exists!')
     {
	     $("#username").removeClass("error_green");
	     $("#username").val();
	     $("#username").focus();
     ...
     if(responseText=='Successfully Register Password send to mobile.')
     {
