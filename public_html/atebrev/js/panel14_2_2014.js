...
function slideAndBack(showObj,hideObj){
	...
	if($(window).width() <= 600){		
		$('.slideAndBack').unbind('click').click(function(){
...
function setActive(hilit){//console.log(hilit);
	...
	if(hilit == 'email.php' || hilit == 'phone.php' || hilit == 'register-ids.php' || hilit == 'personal.php' || hilit == 'change-password.php' || hilit == 'news-updates.php' || hilit == 'reseller-setting.php'){		
		ac('.setting');
		$('#setmenu a').removeClass('active');
		$('.'+hilit.split(".")[0]).addClass('active');
	}
