...
var tb = <?php echo (isset($_REQUEST['tb']))? $_REQUEST['tb'] : 1;?>;
...
function designTransactionLog(text){
 ...
 $.each( text.detail, function(key, item ) {
  str += '<tr class="hvrParent">\
                    ...
                    <td class="alR">\
						<div class="debit fr"></div>\
						<div class="fr hvrChild mrR">('+ item.credit +' '+item.currencyName +') '+item.creditActualCurrency+'</div>\
					</td>\
