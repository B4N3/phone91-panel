   ...
   <div class="inner">
		...
		<div class="slideLeft contentHolder" id="leftsec">
            <ul class="mngClntList acmanager">
                      ...
                      <li onclick="window.location.href='#!account-manager.php|bandwidth-limit.php'" title="change Tariff">
                        	Change Tariff
                      </li>
                      
                      <li onclick="window.location.href='#!account-manager.php|bandwidth-limit.php'" title="change Account Manager">
