...
if(!preg_match('/^[0-9]+/',$_REQUEST['planId']))
{
    echo "please select valid dialPlan.";
    die();
}  
...
<!--//For Add below code will visible-->
<input type="text" class="fl" placeholder="Find prefix" id="countryNameSearch" name="search" value="" onkeyup= "searchPrefix($(this))">   
