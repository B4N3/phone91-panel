...
<div id="leftsec" class="slideLeft commLeftSec">
	<div class="innerSection">
		<ul class="ln mngClntList pinsListing commLeftList">
...
//            window.location.hash = "#!callshop.php";
        }
...
function callShopLiFunction(userId,ths,event)
{
    if($(event.target).hasClass('callShopDelete'))       
        return false;
    $('.callShopLi').removeClass('selected');
    ths.addClass('selected');
    window.location.href='#!callshop.php|callshop-active-call.php?shopId='+userId;
}
