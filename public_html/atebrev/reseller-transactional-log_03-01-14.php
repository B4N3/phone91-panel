                      ...
                      <?php $totalCredit=0;$totalDebit=0;
                            foreach($transData as $detail){ ?>
                              <tr class="">
                                        ...
                                        <td  class="alR"><?php echo $detail['amount'];?></td>
                                        <td class="alR"><?php echo $detail['currentBalance'];?></td>
                                        <td><?php echo htmlentities($detail['description']);?></td>
                                        <td  class="alR">
                                        	<span class="debit">(<?php echo $detail['debit'] . " " . $detail['currencyName']; ?>) <?php echo $detail['debitActualCurrency']; ?></span>
                                        </td>
                                        <td class="alR">(<?php echo $detail['credit'] . " " . $detail['currencyName'];?>)<?php echo $detail['creditActualCurrency']; ?></td>
