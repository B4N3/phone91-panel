...
//                    callType = value.call_type;
                ...
                str += '<li class="clear logLi slideAndBack" id="logLi'+value.called_number+'" onclick="getLogDetails('+value.called_number+',$(this))">\
...
//                                    </a>\
			...
			if(storage.getItem('currentId')){console.log('#logLi'+storage.getItem('currentId'));				
