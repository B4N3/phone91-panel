    ...
    <div id="tabs-1" class="tabs">
       ...
       <!-- Bootm Actions Wrapper-->
        ...
        <div class="transMoney clear fl">
            <form id="addreducetransForm" class="formElemt">        
            ...
            <div id="addReduceFund" class="transInner" style="<?php echo $deletedStyle;?>">
                ...
                <div class="actionDiv">
                    ...
                    <div class="fields">
                    <input type="submit" class="btn btn-mini btn-blue" name="additionalTrans" id="additionalTrans" value="ADD TRANSACTION"/>
                    </div>
                </div>
            </div>
          </form>  
...
$(document).ready(function(){
   	...
   	var options = { 
                        ...
                        type:'POST',        
			dataType: 'json',
			beforeSubmit:  showaddreduceRequest,  // pre-submit callback 
			success:     
                                function(text)
                                {
                                 show_message(text.msg,text.status);
		...
		$('#addreducetransForm').ajaxForm(options); 
                
     
});
$().ready(function() {
        // validate the comment form when it is submitted 
        $("#addreducetransForm").validate({
                rules: {
                        transAmount :{
                            required: true,
                            maxlength: 8,
...
function showaddreduceRequest(formData, jqForm, options){
	console.log(0)
