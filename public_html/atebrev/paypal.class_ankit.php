...
class paypal_class {
   ...
   function validate_ipn() {
      ...
      if(!$fp) {
       ...
       //,'shubh124421@gmail.com'
      $sesObj->sendmail_mandrill(array('AnkitPatidar@hostnsoft.com'),'Phone91 Report enter in ipn2,check for verified:',print_r($this->ipn_response,1),$from);
