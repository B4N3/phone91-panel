...
switch ($_GET['action'])
{
   ...
   case 'ipn':          // Paypal is calling page for IPN validation...
       ...
       {
           //tracker for user details
           $trackId = $funObj->paymentTracker($trackId, $startTimTracker,'','This paypal id is blocked!!!',$_REQUEST); 

           //redirect to buymore page
           header("location:'".$_SERVER['SERVER_NAME']."'/userhome.php#!setting.php|buymore.php?msg=paypalIdBlocked");
       ...
       if($getRows > 0)
       {
           ...
           //redirect to buymore page
           header("location:'".$_SERVER['SERVER_NAME']."'/userhome.php#!setting.php|buymore.php?msg=maxLimit");
           //stop and exit the script
       ...
       if($getRowsIp > 1)
       {
           ...
           //redirect to buymore page
           header("location:'".$_SERVER['SERVER_NAME']."'/userhome.php#!setting.php|buymore.php?msg==maxIpLimit");
           //stop and exit the script
        ...
        if($paymentStatus == 'Reversed') //Reversed
	{
        ...
        if($dbIp == $ip and $recharge == $actUserCharge)//validate with ip and talktime and recharge amount
        {
            ...
            $tranxObj->addTransactional_sub($resellerId,$idClient,$dbTalktime,$totalBal,'voip',$dbTalktime,0,$closingBalance,'txnId:'.$txnId,$currencyId);
