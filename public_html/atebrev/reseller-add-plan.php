...
<div id="addPlanWrap">
    <form name="addPlanForm" id="addPlanForm" method="post"  enctype="multipart/form-data" onsubmit="console.log(validateInsertRows());return validateInsertRows(); ">
            ...
            <div class="box-imp">
                ...
                <div class="dn" id="tariff_table">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="cmntbl" id="trfTbl">
                        ...
                        <tr>
                            <td><input type="text" value="" class="cntryCode" id="countryCode0" name="countryCode[]"  /></td>
                            <td><input type="text" value="" class="cntryName" id="countryName0" name="countryName[]" /></td>
                            <td><input type="text" value="" class="operator" id="operator0" name="operator[]" /></td>
                            <td><input type="text" value="" class="rate" id="rate0" name="rate[]" /></td>
                        </tr>
                        <!--<tr>
                            <td colspan="3">
                            </td>
                    ...
                    <div class="commnPlus mrT1">
                        <a class="themeLink" href="javascript:void(0);" onclick="addRow();" title="Add">Add row</a>
                    </div>
        ...
        <input type="hidden" value="<?php echo $_SESSION['captcha']; ?>" name="identificationNumber" id="identificationNumber"/>
        <div class="fields">
            <label>Output Currency</label>
            <select name="currency" style="width:190px;" class="currencyList">
                <!--  do not remove currencylist class -->
            </select>
        </div>
<!--        <div class="fields">
...
<button value="Add Plan" title="Add Plan" class="btn btn-medium btn-primary clear alC" onclick="$('.progress').show();">
            <div class="tryc tr3">
