    	...
    	<div id="transactionTable" class="tablflip-scroll">
            ...
            <tbody>
                ...
                <tr class="hvrParent">
                    ...
                    <td class="alR"><div class="fl"><?php echo $trans['currentBalance']; ?></div> </td>
                    ...
                    <td class="alR closeBalance"><div class="fl"><?php echo $trans['closingBalance']; ?></div></td>
                </tr>
                <?php
