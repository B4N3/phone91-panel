...
<!--<script type="text/javascript" src="js/panel.js">
                ...
                <li class="bdrTrns pr setting" onclick="uiDrop(this,'#showSetting', 'true')">
      					<div class="clear cp"> 
                                <span id="namewrap" class="fl clear">
                                      <i class="ic-32 ph fl"></i><p id="firstName" class="semi fl"><?php echo $_SESSION['username'];?></p>
                                 </span>
