...
<div id="header" class="clear">
	 <a href="#menu-left" class="menuLeft"></a><span id="screen" style="position:absolute"></span>
          ...
          <div class="deskMenu  clear">
                ...
                <!--Logo Here-->
                <div id="logosec">
               		 <a href="/index.php"><img src="<?php echo (isset($logoImage) && $logoImage != ''? $logoImage :((($_SERVER['HTTP_HOST'] == "voice.phone91.com")||($_SERVER['HTTP_HOST'] == "voip91.biz"))?'images/phone91-logo.png':'You Logo Comes Here')) ?>" height="46px" alt="You Logo Comes Here" /></a>
               </div>
       		  <!--//Logo Here-->
             <!--User Menus-->
