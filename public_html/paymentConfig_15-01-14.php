...
$successEmails = array(DEFEMAIL1,DEFEMAIL2);//$defEmail2,,DEFEMAIL2

//set default mail on sucesses
$cashuSuccessEmails = array(DEFEMAIL1,DEFEMAIL2);//$defEmail2,,DEFEMAIL2
...
$returnUrl = $sandbox ? 'https://voip91.com/checkoutResponse.php' : 'https://voip91.com/checkoutResponse.php';
$cancelUrl = $sandbox ? 'https://voip91.com' : 'https://voip91.com';
$bussiMail = $sandbox ? 'ankkuboss@paypal.com' : 'payment@walkover.in';
$notifyUrl = $sandbox ? 'https://voip91.com/checkoutResponse.php' : 'https://voip91.com/checkoutResponse.php';
