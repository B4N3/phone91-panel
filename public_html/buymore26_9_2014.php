...
<!--                                                    <li  id="creditDebit" class="active nonstripe" onclick="paymentButton(this)" >Credit/Debit Card<span class="paySpan ic-16 correct"></span></li>-->
							...
							?>
                                                        ...
                                                        <li  id="strip" class="stripe" onclick="paymentButton(this)">Credit/Debit Card<span class="paySpan ic-16"></span></li>
                                                        <?php } 
						...
						<div id="normalPay" class="<?php echo $dnClass;?>"><a class="btn btn-medium btn-primary" href="javascript:GetAll();" title="Pay">Pay</a></div>
                                                ...
                                                <div class="stripbtn" id="stripePay" >
                                                    ...
                                                    <a id="customButton" class="btn btn-medium btn-primary" href='javascript:;' onclick="saveOrder();">Pay</a>
...
var handler = StripeCheckout.configure({
    key: '<?php echo STRIPE_PUBLIC_KEY;?>',//'pk_test_XpPymVUnHZWQ0SFRyRsV4Bxm',
    currency:'INR',
    ...
    token: function(token) {
        ...
        $.ajax({
                 ...
                 type:'POST',
                 data: {token:token,orderId:orderId,id:trackId},
                 dataType:'json',
