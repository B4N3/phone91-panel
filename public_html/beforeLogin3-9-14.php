    ...
    <body>
        ...
        <div class="mainFeaturesWrapper">
            <section id="featuresWrap1" class="noBanner">
                <section class="innerBanner pr alC" >
                    <!-- First Sreen Strat-->
                 
                 <div id="firstScreen">
                 	<h2 class="whClr mrB4"> Welcome User, choose your currency -</h2>
                    <form id="currencyForm">
                      ...
                      <option value="108">NZD</option>
                        ...
                        <input onclick="updateUserCurrency($('#currencySelectBox').val());" class="forgetbutton" type="button" id="currencyButton" name="currencyButton" value="Done" />
                    </form>
                </div>
