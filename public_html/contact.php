...
#if reseller than go to reseller panel 
if($_SESSION["client_type"] == 2)
{
    $funobj->redirect("/userhome.php#!reseller-manage-clients.php");
    exit();
}
...
#accessNoDetails .selectric,.editContact .selectric{
    width: 150px;
}
		...
		<form id="contact_detail" action="javascript:;">
		  <div id="add-cnt-inner">
			...
			<div class="addCntrow clear bdrB addrows">
                        ...
                        <div class="child">
                            ...
                            <div class="selectBoxWrapper">
                                    <select  class="srcSelect">
                                     ...
                                     <div class="codeInput">
                                         <input name="code[]" type="text" id="code" class="codeSource min code defaultCode_1" value="91" onkeyup="updateFlag(this)"/>
                        ...
                        <div class="child accCont" id="conHide" >
				  ...
				  <div class="addCntrow clear bdrB">
                        ...
                        <div class="child">
                            ...
                            <div class="countryWrap">
                                 ...
                                 <div class="codeInput">
                                        <input name='code' type="text" id="code" onKeyUp="updateFlag(this); selectOption($(this).val())" class="codeSource min" value="91" />
                                        <input class="pr contact" name="contact[]" id='mobileNumber' type="text" placeholder="Contact No" />
                                 </div>
                                  </div>
                             </div>
    ...
    <div>
        <div id="tabs-1" class="tabs">
            <div class="clear bdrB pdB2 pdT1">
            	<div class="accErr pd1 bdr clear mrB2" id="myCountry" style="display:none;">
                	<span class="ic-32 notif fl mrR1"></span>
                        <p class="f15 ligt mrT"> Can't find an access number for your country?  </p>
                        <p class="f15 ligt mrT"> Mail your country name to support, we might provide you!  </p>
                </div>
                ...
                <div class="wcBox twBox pr mrB2">
                    ...
                    <div class="countryWrap">
                        ...
                        <div id="details" style="display:none">
                            ...
                            <div class="codeInput">
                                <input name='code' type="text" id="codeWebCall" class="codeSource min " value="91" onkeyup="updateFlag(this)"/>
                        ...
                        <div class="selectBoxWrapper">
                            <select  class="srcSelect">
                                ...
                                foreach ($country as $key => $countryNames) {
                                    $ccode = explode('/', $countryNames['ISO']);
                                    echo "<option countryFlag=" . $ccode[0] . " value=" . $countryNames['CountryCode'] . "  ".(($countryNames['CountryCode'] == "91")?"selected='selected'":"")."   >" . $countryNames['Country'] . "</option>";
//                                    echo "<option countryFlag=" . $ccode[0] . " value=" . $countryNames['CountryCode'] . "  >" . $countryNames['Country'] . "</option>";
                                }
                                ?>
                            </select>

                            <div class="codeInput">
                                <input name="code" type="text" id="codeSource" class="codeSource min defaultCode_twoWay" value="91" onkeyup="updateFlag(this)" />
                                <input class="pr contact fl sourceDestNo"  value="<?php echo $meCntNumber; ?>" id="source" type="text"/>
                ...
                <div class="twBox">
                    ...
                    <div class="countryWrap">
                        <div class="selectBoxWrapper">
                            ...
                            <div class="codeInput">
                                <input name='code' type="text" id="codeDest"  class="codeSource min defaultCode_twoWay " value="91" onkeyup="updateFlag(this)" />
                                <input class="pr contact fl sourceDestNo" id="dest"  type="text" />
                            </div>
                        </div> <!-- countryboxwrapper end here -->
                    </div>
                    <div class="statCnt mrT4 callEnd">
    ...
    <div id="gameBox">
    	...
    	<div id="canvasCnt">
            ...
            <div id="mainMenu">
                ...
                <p class="info">
                    use
                    <span class="key left">â†?</span>
                    <span class="key right">â†’</span>
