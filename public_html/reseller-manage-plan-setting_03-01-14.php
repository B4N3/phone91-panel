...
<div id="manage-plan-setting">
    ...
    <div id="mnpSettLeft">
		...
		<i class="ic-24 edit cp mrL mrT"id="planEdit" onclick="planNameStateChange();"></i>
            <select name="" class="selectretail" onchange="getTariffDetails($('#currentSelected').val(),$(this).val())">
                <option>100</option>
                <option>50</option>
                <option>25</option>
            </select>
		<div class="clear"></div>	
        <p class="mrB2">
            Currency <?php echo $planArr['currency']; ?>
        </p>
        <input type="text" value="" placeholder="Search" class="mrL" onkeyup="searchTariff($(this))"/>
		<input onclick="deleteAll();" type="button" name="deleteSelected" id="deleteSelected" value="Delete Selected" class="btn btn-mini btn-danger" title="Delete Selected"/>
        

        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="" class="cmntbl boxsize editable mrT1">
            <thead>
                <tr>
            ...
            <div class="box-imp">
                ...
                <div class="dn" id="tariff_table">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="cmntbl" id="trfTbl">
                        ...
                        <tr>
                            <td><input type="text" value="" id="countryCode0" name="countryCode[]" class=""  /></td>
