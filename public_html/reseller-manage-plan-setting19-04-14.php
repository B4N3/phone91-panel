...
$currencyList = $funobj->getCurrencyList();
?>
        ...
        <table border="0" cellspacing="0" cellpadding="0" id="" class="cmntbl boxsize mrT1">
            <thead>
                <tr>
                    ...
                    <th><input type="text" value="" placeholder="Country Code" onkeyup="searchTariff($(this))" style="width:100px" /></th>
                    <th><input type="text" value="" placeholder="Country Name" onkeyup="searchTariff($(this))"/></th>
                    <th>Operator</th>
