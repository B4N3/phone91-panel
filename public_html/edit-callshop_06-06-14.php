           ...
           <div id="ecallshop" title="Edit Call Shop">
               <form name="editCallshop" id="editCallshop">
                    <div class="fields">
                        ...
                        <input type="text"  name="name" value="<?php echo $response; ?>"/>
                        <input  type="hidden" value="<?php echo $_REQUEST['callShopId']; ?>" name="userId"/>
                        
                    </div>
                    <div class="fields">
                        <label>Tariff Id:</label>
                        <select class="callshopsele" name="selPlan" id="selPlan">
                            <option>Tarrif</option>
                        </select>
                    </div>
                   
                    <div class="fields">
                        <input type="checkbox" name="callRecordStatus" id="callRecordStatus" value="1" <?php if(isset($result) && $result ) { ?>checked="checked" <?php } ?> > Call Record
                    </div>
