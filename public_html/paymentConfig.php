...
defined('SUCCESSMAILS') or define("SUCCESSMAILS",serialize($successEmails));
...
$stripeSecretKey = $stripeTestMode ? 'sk_test_2nH3WLkP4J2tBGxskLTJPLml' : 'sk_live_hK16lGSkHYZKrQpcAUdYXOj8';
$striprPublicKey = $stripeTestMode ? 'pk_test_XpPymVUnHZWQ0SFRyRsV4Bxm' : 'pk_live_rzmIEcHzKbPrdBvLv9VFUWWb';


defined('STRIPE_SECRET_KEY') or define("STRIPE_SECRET_KEY",$stripeSecretKey); 

defined('STRIPE_PUBLIC_KEY') or define("STRIPE_PUBLIC_KEY",$striprPublicKey); 
