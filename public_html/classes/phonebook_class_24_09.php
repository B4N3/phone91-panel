...
accessType	1
      ...
      $condition = array( 'contactNo' => $allcontact ,
        ...
        return json_encode(array("status" => "success", "msg" => "Contact number updated!", "str" => $str));    
    }
    ...
    */
	...
	$data = array();
	 ...
	 return json_encode(array('status' => 'success' ,'msg' => 'Successfully found records! ','data' => $data)); 
