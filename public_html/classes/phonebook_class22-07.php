...
class phonebook_class {
    ...
    if ($result <= 0){
     ...
     $data=array("userid"=>$userid,"emp_id"=>"sudhir@gmail.com","name"=>"sudhir pandey");
...
//        if($parm['data'] != '')
//        {
//            if(preg_match("/^[0-9]+$/",$parm['data'])){
//            $condition = array("contact.contactNo"=>(int)$parm['data']); 
//            }else
//            $condition = array('contact.name' => $parm['data']); 
//        }
//     
//        $result =$dbobj->mongo_find($collectionName,$condition,array('contact.$'=>1));
//       
