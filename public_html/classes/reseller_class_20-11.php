...
class reseller_class extends fun 
{
    ...
    function editFund($parm,$userid)
    {
      ...
      $result = $transaction_obj->addTransactional($userid,$parm['toUserEditFund'],$fundAmount,$talktime,$fundpaymentType,$parm['fundDescription'],$pType,$parm['partialAmt'],$parm['fundCurrency']);
    ...
    function manageClients($request, $session, $allclient = null) 
    {
        ...
        if (isset($q) and trim($q) != '') 
        {
            ...
            if($allclient != null)
            {
              ...
              $result =  $this->allUserDetail($allUserCondition); 
            }
            else
