...
//                            $status = $get_userinfo['reason'];
        ...
        function cutCurrentCall($uniqueId,$userId){
            $this->status = "error";
...
//            echo $uniqueId = trim($userId);
            ...
            $result = $this->selectData('id_active_call', '91_currentCalls', "uniqueId='".$uniqueId."' and id_client='".$userId."'");
//            echo $this->querry;
            if(!$result  ){
                $this->code = "503";
...
//            die();
            ...
            {
//                echo $id_active_call;
                $cmd1 = "/usr/sbin/asterisk -rx 'channel request hangup  ".$row['id_active_call']." ' 2>&1 ";
