...
//		return $result;
    ...
    function editFund($parm,$userid){
      ...
      $result = $transaction_obj->addTransactional($userid,$parm['toUserEditFund'],$fundAmount,$talktime,$parm['fundPaymentType'],$parm['fundDescription'],$pType,$parm['partialAmt']);
