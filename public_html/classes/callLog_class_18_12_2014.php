...
//                  $sumofDuration += $row['totalNumber'];
    ...
    function getAllCallDetails($fromDate,$toDate = NULL)
    {
...
//                  $sumofDuration += $row['totalNumber'];
        ...
        $balResult = $this->selectData("sum(deductBalance)", "91_chainBalanceReport",$con);
...
//            $clientName = json_decode($clientNameJson,TRUE);
    ...
    function getCallDeatilsAdmin($userId,$keyword,$type,$route,$status,$sDate,$eDate,$pageNo=1,$exportOpt=0)
    {
        ...
        $columns = "SQL_CALC_FOUND_ROWS id_client,id_chain,caller_id,called_number,call_start,call_end,status,hangup_reason,call_type,balance_deduct,route,didNumber";
        $table = "91_calls";
