...
class transaction_class extends fun
{
   ...
   /**
    ...
    {
        if(!preg_match(NUM_REGX, $id) && !preg_match(DECIMAL_REGX, $amount))
        {
            return 0;
        }   
   ...
   /**
    ...
    function updateUserBalance( $toUser, $talktime, $sign = '+')
    {
	 ...
	 if(!preg_match(NUM_REGX, $toUser) || !preg_match(DECIMAL_REGX, $talktime) || ($sign != '+' && $sign != '-'))
        {
            return 0;
        }   
...
'.$commonMsg;
    ...
    {
	if(!preg_match(NUM_REGX, $toUser) || !preg_match(NUM_REGX, $currency) || !preg_match(DECIMAL_REGX, $amount))
        {
            return 0;
        }   
