...
//	if(isset($param['signupFrom']))
       ...
       $createUserResult = $this->createUser($param, $this->tariffId,$balance, $currencyId);
        ...
        if($this->singleCurrencyFlag == 1 || (isset($param['domain']) &&  $param['domain'] == "phone91.com" && $param['signupFrom'] != '1') || $parm['isApi'] == "1" )
...
//        	    var_dump($result);
    ...
    function check_email_avail($email ,$domainName = NULL ) 
    {
