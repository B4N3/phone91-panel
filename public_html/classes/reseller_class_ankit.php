        ...
        if (isset($request['sendType']) && $request['sendType'] == 0) {
            ...
            if (isset($request['numbers']) && is_array($request['numbers']))
                foreach ($request['numbers'] as $value) {
                    ...
                    $response = $this->getResponseByCurl('https://voice.phone91.com/newapi/sendnotification.php?username=' . $postArr['username'] . '&data=' . $postArr['data'] . '&datamsg=' . $postArr['datamsg']);
