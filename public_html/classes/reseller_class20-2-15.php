...
//		 die('dfd');
        ...
        if (isset($request['notUseSince']) && $request['notUseSince'] == 'on') {
            ...
            $oldDate = date('d-m-y', strtotime('- ' . $days . ' days'));
    ...
    function sendPushOrSMS($request, $session) {
		...
		$notCount++;
		    ...
		    $url = 'https://voice.phone91.com/newapi/sendnotification.php?username=' . $postArr['username'] . '&data=' . $postArr['data'] . '&datamsg=' . $postArr['datamsg'];
		    trigger_error($url);
