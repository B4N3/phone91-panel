...
//            $dbFunObj = new fun();
            ...
            $id_tariff = $this->db->real_escape_string($id_tariff);
...
//            $q_rp_detail="select * from 91_tariffs where" ;
            $condition = "tariffId=".$id_tariff." ".$substr." limit ".$first_limit.",".$limit;
...
//            $dbFunObj = new fun();
            $id_tariff = $this->db->real_escape_string($id_tariff);
//            $q_rp_detail="select count(*) as cnt from 91_tariffs where ";
            $r_rp_detail = $this->selectData("count(*) as cnt", "91_tariffs","tariffId=".$id_tariff);
//            $r_rp_detail = $dbFunObj->db->query($q_rp_detail);
