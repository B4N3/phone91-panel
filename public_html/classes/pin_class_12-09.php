...
//					managePlans			
	...
	function batchStatus($request){
        ...
        $str.='<li class="" onclick="showPinDetail(this,event);" batchid="'.$pinDetails['id'].'" >
                    ...
                    <p class="exp">Expire on '.$pinDetails["expire_date"].'| '.$pinDetails["paymentType"].'</p>';
                      if($pinDetails['action'] == 0){
                        $str.='<input type="button" class="action btn btn-mini btn-primary" name="play" id="play" value="play" onclick="enablePinBatch(this,1);" batchId="'.$pinDetails['id'].'" />';
                      }else{
                        $str.='<input type="button" class="action btn btn-mini btn-danger" name="stop" id="stop" value="stop" onclick="enablePinBatch(this,0);" batchId="'.$pinDetails['id'].'" />';
                      }
                      if($pinDetails['amountStatus'] == 0){
                        $str.='<input type="button" class="action btn btn-mini btn-primary " name="unPaid" id="unPaid" value="unPaid" onclick="amountStatusPaid(this,1);" batchId="'.$pinDetails['id'].'" />';
                       }else{
                        $str.='<p class="dt"> Status : Paid </p>';
                       }
                    $str.='</li>';
