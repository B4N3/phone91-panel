            ...
            <section id="featuresWrap1" class="noBanner">
                ...
                <div id="firstScreen"> 
                    ...
                    <div class="talkStp"  >
                        <div class="steps"   >  
                            <div class="st">Message</div>
                            <div style="display:table-cell; vertical-align:middle; height:110px; font-size:19px">  In case you entered a wrong number, you can always go <u> <strong>back</strong> </u> and change it!</div>
                        </div>
                    </div>
                </div>
