                    ...
                    <tbody>
                          ...
                          <tr class="">
                            ...
                            <?php if($userDetail['deleteFlag'] > 0){ ?>
                                <span title="Login As" class="login loginAs" onclick="redirectLoginUrl(<?php echo $userDetail['userId']; ?>);" >Deleted</span>    
                            <?php }
                                        elseif($userDetail['blockUnblockStatus'] > 1) {?>
                                                    <span title="Login As" class="login loginAs" onclick="redirectLoginUrl(<?php echo $userDetail['userId']; ?>);" >Blocked</span>    
                                        <?php }
                            
                                  else {?>
                                       <span title="Login As" class="ic-24 login loginAs" onclick="redirectLoginUrl(<?php echo $userDetail['userId']; ?>);" ></span>              
                                        <?php }
                                        ?>       
