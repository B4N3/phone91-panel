<?php
/*! Phone91 - 1.0.5 - 304e44fae52b81256e7624dbca2a9cb3d005808e*/
/*
 * Phone91
 * http://Phone91.com
 *
 * Copyright (c) 2014 Phone91, contributors
...
define( 'HELP_URL'             , 'http://Phone91.com' );
...
function init() {
	...
	if ( ! defined( 'TITLE'                      ) ) define( 'TITLE'                      , 'Phone91' );
	if ( ! defined( 'TITLE_FILE'                 ) ) define( 'TITLE_FILE'                 , 'Phone91 Log [%f]' );
	if ( ! defined( 'NAV_TITLE'                  ) ) define( 'NAV_TITLE'                  , '' );
	if ( ! defined( 'FOOTER'                     ) ) define( 'FOOTER'                     , '&copy; <a href="http://www.Phone91.com" target="doc">Phone91</a> 2014-' . @date('Y') . ' - <a href="http://Phone91.com" target="doc">Phone91</a>');
	...
	if ( ! defined( 'PIMPMYLOG_VERSION_URL'      ) ) define( 'PIMPMYLOG_VERSION_URL'      , 'http://Phone91.com/version.js' );
	if ( ! defined( 'PIMPMYLOG_ISSUE_LINK'       ) ) define( 'PIMPMYLOG_ISSUE_LINK'       , 'https://Phone91.com/issues/' );
