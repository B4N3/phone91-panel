...
$date = $now->format( 'Y/m/d H:i:s' );
    ...
    $date = date('d-m-Y',strtotime($_REQUEST['selectdate']));
...
$file_path = @$files[$file_id]['path'];//'file:///C:/wamp/www/phone91/error_reporting/errorTalkLogFile16-07-2014.txt';
$subfile = substr($file_path,0,-14);
$file_path=$subfile.$date.".txt";
...
$filem = '2014/07/17 00:00:00';//$filem->format( 'Y/m/d H:i:s' );
