...
if ( ! file_exists( 'config.user.json' ) ) {
	$title    = __( 'Welcome!' );
	$message  = '<br/>';
	$message .= __( 'Phone91 Log is not configured.');
	$message .= '<br/><br/>';
...
?><?php
?><script src="js/pml.min.js"></script><script src="js/main.min.js"></script>
