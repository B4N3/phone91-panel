...
unset($total_rows);unset($limit);unset($p);unset($i);unset($_REQUEST);
            ...
            var options = {
                ...
                success:    function(msg){ 
                    ...
                    if(msg=='Record Added successfully')
                    {
                        ...
                        $('#contentright').load( 'transaction_log.php');      
                    }
                    else
...
<?php } 
        ...
        unset($_REQUEST);
        unset($page_number);
        unset($p,$i,$limit,$res,$row,$total_rows,$user_obj,$val,$GLOBALS);
?>
