(function($) {
	...
	$.fn.draw = function(o,obj,selectedpage){
		...
		if (o.show_first == true) {//Updated by Rahul Chordiya
		_divwrapleft.append(_first).append(_rotleft);
		}
		else
		var _first		= $(document.createElement('p')).addClass('jPag-first').html('First');
		...
		if (o.show_last == true) {//Updated by Rahul Chordiya
		_divwrapright.append(_rotright).append(_last);
		}		
		
		
		  var _divpagechoice = null;
        if (o.page_choice_display == true) {//Updated by Rahul Chordiya
            ...
            _divpagechoice = $('<div />').addClass('jPag-pageChoice')
                .append($('<label />').addClass('jPag-pageChoice-label').html('Go->Page#'))
                .append($pagechoicevalue);
        }

        var _divitemcount = null;
        if (o.item_count_display == true) {//Updated by Rahul Chordiya
