...
{
    echo "you have no permission to show user Detail";
    die();
}
...
$transaction = $transObj->getTransactionLogDetail($fromUser, $clientId);
...
<div id="tabs">
    <ul>
            <li onclick ="getTransactionLog(<?php echo $fromUser;?>,<?php echo $clientId;?>)"><a href="#tabs-1">Transaction Log</a></li>
            <li><a href="#tabs-2">Edit Fund</a></li>
            <li><a href="#tabs-3">Edit Info</a></li>
    	...
    	<div id="transactionTable" class="tablflip-scroll">
            ...
            <tbody>
                ...
                <tr class="hvrParent">
                    ...
                    <td class="alR"><div class="credit fr"><?php echo $trans['creditActualCurrency']; ?></div><div class="dn hvrChild fr mrR">(<?php echo $trans['credit'] . " " . $trans['currencyName'];?>)</div></td>
        ...
        <div class="clear mrT1">
            ...
            <div class="actionDiv mDevice">
                ...
                <div id="sporow" class="clear">
                    ...
                    <input type="button" class="btn btn-medium btn-primary mrL" name="additionalTrans" id="additionalTrans" value=" ADD " onclick="addAdditionTransaction();"/>
                </div>
            </div>
    ...
    <div id="tabs-2" class="tabs">
        <form id="editFundform" class="formElemt">
                ...
                <div class="innerSpace">
                        ...
                        <h3 class="mrB2 userBalance"><?php echo round($UserBalance,3); ?></h3>
                        <div id="sporow" class="clear"> 
                                <div class="fields">
                                        <label>Amount currency</label>
                                        <select name="fundCurrency" id="fundCurrency">
                                                <option value="147">USD</option>
                                                <option value="63">INR</option>
...
<!--                                                <option value="48">GBP</option>-->
    ...
    <div id="tabs-3" class="tabs displayEditInfo"><!--display number and email info-->
        ...
        <div id="userToReseller"><br>
                <a onclick ="changeUserToReseller(<?php echo $clientId;?>);" style="color:rgb(14, 14, 70);font-size:14px">Click here to change user to reseller</a>
        </div>
        <?php } ?>
        <?php {?>
        <div id="listenRemainingMin"><br>
                <a onclick ="listenRemainMinStatus(<?php echo $clientId;?>);" style="color:rgb(14, 14, 70);font-size:14px">Click here </a><span> If you want to listen the remaining minutes during the call.</span>
        </div>
        <?php } ?>
        
        <div><br>
                <input type="checkbox" name="changeSip" <?php  ($userInfo['sipFlag'] == 1?$check = "checked = checked":$check ="");echo $check; ?> onclick="changeSipSetting(<?php echo $_REQUEST['clientId']; ?>)" id="changeSip" value="" /><span>Enable/Disable Sip</span>
        </div>
    </div>
    <!--3rd  Tab Content-->
