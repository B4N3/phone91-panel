	    ...
	    <section id="featuresWrap">
	    	<section class="wrapper pr">        	
	            <div class="searchFields fl col2">
	               ...
	               <form method="POST" action="" id="contactForm" onsubmit="return contactForm();"  class="text2">
                   	<div >
                    <a class="textc"> Name : </a>
                            <input type="text" id="contactName"   name="" value=""  placeholder="Name" style=" margin-bottom:10px !important;"  />
                 ...
                 <a class="textc"> Phone Number : </a>
	                    <input  type="text" id="contactPhone"  value="" name="phone" placeholder="Phone Number" onkeyup=""  style=" margin-bottom:10px !important;"  />
	                    <a class="textc"> Comment : </a>
                        <textarea id="contactComment" rows="4"></textarea>
