	    ...
	    <section id="featuresWrap">
	    	<section class="wrapper pr">        	
	            <div class="searchFields fl col2">
	               ...
	               <form method="POST" action="javascript:;" id="contactForm" onsubmit="return contactFrom();"  class="text2">
                   	<div >
                    <a class="textc"> Name : </a>
                            <input type="text" id="contactName"   name="name" value=""  placeholder="Name" style=" margin-bottom:10px !important;"  />
                            <div class="msg pa"></div>
		            <a class="textc" > Email : </a>
                    <input type="email" id="ContactEmail"  name="email" value="" placeholder="Email" onblur="" style=" margin-bottom:10px !important;" />
                 <a class="textc"> Phone Number : </a>
	                    <input  type="text" id="contactPhone"  value="" name="number" placeholder="Phone Number" onkeyup=""  style=" margin-bottom:10px !important;"  />
	                    <a class="textc"> Comment : </a>
                        <textarea id="contactComment" name="message" rows="4"></textarea>
...
<!--        	 <div class="formGet pr">
  ...
  */
  ...
  {
    $.ajax({url:'/action_layer.php?action=contactForm',
            type:'post',
            dataType:'json',
            data:$('#contactForm').serialize(),//'name='+$('#contactName').val(),//+'email='+$('#contactEmail').val()+'number='+$('#contactphone').val()+'message='+$('#contactComment').val(),
