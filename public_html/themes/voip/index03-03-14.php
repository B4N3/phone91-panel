             ...
             <div id="stcnt">             	
                ...
                <aside class="national">
                  ...
                  <div class="fl f10 ">
                    ...
                    <span class="clr"></span>
                    <span class="grayClr2 db">0.9 <span class="fs4">cents/min</span></span>
                  </div>
                </aside> 
                </div>
            	...
            	<aside class="national">
                 ...
                 <div class="fl f10">
                    <a href="javascript:void(0)" class="db" id='United Arab Emirates'>UAE</a>                    
                    <span class="clr"></span>
                ...
                <aside class="national">
                  ...
                  <div class="fl  f10">
                    ...
                    <span class="clr"></span>
                    <span class="grayClr2 db">3.0 <span class="fs4">cents/min</span></span>
                  </div>
                </aside>
                </div>
