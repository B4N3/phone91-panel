...
<title>VoIP Resellers | Private Label VoIP Resellers | VoIP Reseller Providers - Phone91</title>
...
<meta name="description" content="description" content="Join today our White Label Solution, Online Calling Cards & Internet Callshop wholesale VoIP reseller program. Make maximum profit with our VoIP reseller services." />
...
<body>
	...
	<div class="wrapper">
    	<div class="cnthead">Let us know about  <span class="themeClr">your requirements</span></div>
    	<p class="ligt fs18 mrB4">We would be able to help you better.</p>
    	<div id="formwrap" class="clear pr">
            ...
            <form id="reseller-query" action="javascript:void(0)" novalidate="novalidate">
                ...
                <div class="form-row clear">
                	<label class="lbl">You wish to be Reseller via</label>
                    ...
                    <div class="form-row clear">
                        ...
                        <div class="callingAmount">
                        	<div class="rateamount">
                                <input type="text" class="cmninpt" placeholder="in Minutes" id="volume" name="volume" onblur="checkAllEstVolume(this);">
