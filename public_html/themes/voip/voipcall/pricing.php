             ...
             <div id="stcnt">             	
                ...
                <aside class="national">
                  ...
                  <div class="fl f10">
                        ...
                        <span class="clr"></span>
                        <span class="grayClr2 db">1.20 <span class="fs4">cents/min</span></span>
                  </div>
                </aside> 
                </div>
            	...
            	<aside class="national">
                 ...
                 <div class="fl rglr f10 pdR5">
                    ...
                    <span class="clr"></span>
                    <span class="grayClr2 db">14.13 <span class="fs4">cents/min</span></span>
                  </div>
                </aside> 
                </div>
                ...
                <aside class="national">
                  ...
                  <div class="fl  f10">
                    ...
                    <span class="clr"></span>
                    <span class="grayClr2 db">2.86 <span class="fs4">cents/min</span></span>
                  </div>
                </aside>
                </div>
                ...
                <aside class="national">
                 ...
                 <div class="fl  f10">
                    ...
                    <span class="clr"></span>
                  <span class="grayClr2 db">2.95 <span class="fs4">cents/min</span></span>
                  </div>
                </aside>
                </div>
                <span class="clr"></span>
