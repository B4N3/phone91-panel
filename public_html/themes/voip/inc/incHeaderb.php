...
<div class="wrapper">
    <!-- Header -->
   <header id="header">
       <a href="/indexb.php" title="<?php echo $companyName ?>" style="background-image:url('<?php echo MANAGE_PATH.'/'.$generalData['logoimage']; ?>')" id="logo" class="fl"></a>
        <nav class="fl openRegu f16">
                <a class="thmClr" href="/indexb.php" title="Home" id="home">Home</a>
                <a class="" href="/voipcall/how-it-works-gtalkb.php" title="How it works"  id="works">How it works</a>
                <a href="/voipcall/pricingb.php" title="Pricing"  id="pricing">Pricing</a>
                <a href="/resellerb.php" title="reseller"  id="reseller">Reseller</a>	                       
        </nav>
        <?php
