...
<body>
    ...
    <div class="mainFeaturesWrapper">
        <section id="featuresWrap" class="noBanner">
            <section class="innerBanner pr">               
               <h1 class="mianHead fs1 whClr rglr"><div class="fl">What Phone91 Is?</div><span class="f16 db fl mrL1" style="width:68%;">About Phone91</span></h1>
   ...
   <!-- Features -->            
    ...
    <section id="container bgWh">
       <section class="innerContainer mar0auto pdT4 rglr footerPages fs4">
		<!-- Accodians -->
			 <div class="accordion">	

			<!--FirstTab -->
       	      <h3 class="fs2 rglr pdB innerpageHeading active" id="tab1"><a href="javascript:void(0)">Phone91</a></h3>    
            	<div>
					<p class="mrB3 fs4 lightGray lh25">Established in 2008, phone91 has become a leading Easy, Hassle free VoIP solution provider 
	                ...
	                a Internet call which includes Fring, Nimbuzz ,Gtalk. Etc.</p>
                </div>
			<!--//FirstTab -->
            
            <!--SecondTab -->
				<h3 class="fs2 rglr pdB innerpageHeading" id="tab2"><a href="javascript:void(0)">About VoIP Services</a></h3>
        		<div style="display:none;">
					<p class="mrB2 fs4 lightGray lh25">VoIP stands for Voice over Internet Protocol. In this technology Voice has been transmitted via 
					...
					<p class="mrB3 fs4 lightGray lh25">Calling to any phone with VoIP is very cost effective. It has benefits in calling to your residents, 
            ...
            <!--//SecondTab -->
			 ...
			 <!--ThirdTab -->
				<h3 class="fs2 rglr pdB innerpageHeading" id="tab3"><a href="javascript:void(0)">Benefits of VoIP</a></h3>
		       	 <div style="display:none">
					<ul class="listIng lightGray">
