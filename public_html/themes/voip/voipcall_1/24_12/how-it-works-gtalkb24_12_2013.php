...
//create managewebsite object
$webObj = new websiteClass(); 


//get reseller id
$resllerId = $webObj->getResellerId(DOMAIN_NAME);

//get company name
$companyName = $webObj->getCompanyName(DOMAIN_NAME);
//get about data
$abountData = json_decode($webObj->getAboutData(DOMAIN_NAME,$resllerId),TRUE);

//get genral data
$generalData = json_decode($webObj->getGeneralData(DOMAIN_NAME,$resllerId),TRUE);

//set about keyword and description
if(isset($abountData['aboutKeyword']) and $abountData['aboutDescription'])
{
    $aboutKeyword = $abountData['aboutKeyword'];
    $aboutDescription = $abountData['aboutDescription'];
}
else
{
    //set default values
    $aboutKeyword = 'Phone91 is a leading International call provider. Phone91 provides various medium for making cheap international calls and long distance calls.';
    $aboutDescription = 'cheap international calls,  long distance calls.';
}
...
<title>How It Works <?php if(isset($companyName))
                            echo $companyName;
                          else 
                            echo 'Phone91';
?> |International calling with <?php if(isset($companyName))
                            echo $companyName;
                          else 
                            echo 'Phone91';
?></title>
<meta name="keywords" content="<?php echo $aboutKeyword; ?>" />
<meta name="description" content="<?php echo $aboutDescription; ?>" />
...
<?php include_once('../inc/incHeadb.php'); ?>
</head>
<body>
<!-- Header -->
<?php include_once('../inc/incHeaderb.php'); ?>
<!-- //Header --> 
  ...
  <section class="innerContainer mar0auto pdT4 rglr footerPages ">
    <aside class="fl leftSide rglr">
      	<ul class="ln" id="linkli">
            <li><a class="active gtalk" href="how-it-works-gtalkb.php">Gtalk</a></li>
            <li><a class="talk" href="how-it-works-talk.php">Talk for Android</a></li>
            <li><a class="nimbuzz" href="how-it-works-skype.php">Skype</a></li>
