    ...
    <div class="mainFeaturesWrapper">
        <section id="featuresWrap" class="noBanner">
            <section class="innerBanner pr">               
               <h1 class="mianHead fs1 whClr rglr"><div class="fl">Terms and Conditions</div><span class="f16 db fl mrL1" style="width:61%;">Know about 
               Phone91's Terms</span>
               	</h1>
	...
	<!-- Container -->        
	    <section id="container bgWh">
	       <section class="innerContainer mar0auto pdT4 rglr footerPages fs4 lightGray">
			 ...
			 <div class="accordion">
			<!-- Firstheader -->
                  <h3 class="fs3 rglr pdB innerpageHeading active" id="tab1"><a href="javascript:void(0)">Refund Policy</a></h3>
				  <div>
							<p class="pdB1 lightGray lh25">We will refund all the amount that you did not utilize, For example:You paid 10,000 GBP For 100,000 
		                    ...
		                    <ul class="listIng termsListing pdB1 mrB2 lightGray">    
	                            <li class="listHead fwB grayClr2">Notes:</li>	
							...
							<p class="grayClr2 f16 blackCOlor pdB15">Before reading the articles below, please take good notice of the following
                             preliminary terms, which terms make use of some of the definitions as specified in Article 1 below:</p>
														
							
							<p class="pdB15 lh25"><b class="blackCOlor">Entering into this Agreement:</b> This End User License Agreement constitutes a 
							...
							<p class="pdB15 lh25"><b class="blackCOlor">Electronic Signatures and Agreement(s):</b> You acknowledge and agree that by 
							...
							<p class="pdB15 lh25"><b class="blackCOlor">Jurisdiction's Restrictions:</b> If You are residing in a jurisdiction 
                 ...
                 <!-- Secondheader -->        
                   <h3 class="fs3 rglr pdB innerpageHeading bottomSPce" id="tab2"><a href="javascript:void(0)">Definitions</a></h3>
					<div  style="display:none;">
				 			 <p class="onePad">In this Agreement the following capitalized definitions are being used, singular as well as plural.</p>
                             <ul class="listIng termsListing pdB1 mrB2 lightGray moreDetails">
                               
                               <li><span class="blackCOlor">Affiliate:</span> any corporation, company or other entity that directly or indirectly 
                                ...
                                <li><span class="blackCOlor">Agreement:</span> this End User License Agreement, as may be renewed, modified and/
                                or amended from time to time.</li>                                
                                
                                <li><span class="blackCOlor">API:</span> application program interface that is included in or linked to the 
                                Phone91 Software.</li>
                              
                                <li><span class="blackCOlor">Documentation:</span> any online or otherwise enclosed documentation
                                 provided by Phone91.</li>
                             
                                <li><span class="blackCOlor">Effective Date:</span> the date on which this Agreement is entered into by clicking 
                                on the ACCEPT button as stated above or by downloading, installing and (continuously) using the Phone91 Software.</li>
                             
                                <li><span class="blackCOlor">IP Rights:</span> any and all intellectual property rights, including but not limited 
                                ...
                                <li><span class="blackCOlor">Phone91:</span> A trademark of Phone91 Sarl, a company established under 
                               the laws of Luxembourg.</li>
                             
                               <li><span class="blackCOlor">Phone91 Promotional Materials:</span> any and all names, signs, logos, 
                               ...
                               <li><span class="blackCOlor">Phone91 Software:</span> the software distributed by Phone91 for internet 
                               ...
                               <li><span class="blackCOlor">Phone91 Staff:</span> the officers, directors, employees and agents 
                               ...
                               <li><span class="blackCOlor">Phone91 Website:</span> any and all elements and contents of the website 
                               available published by Phone91.</li>
                              
                               <li><span class="blackCOlor">UI:</span> the user interface of the Phone91 Software.</li>
                                
                               <li><span class="blackCOlor">You:</span> you, the end user of the Phone91 Software, also used in the form "Your" where 
                                applicable.</p>
                ...
                <!-- Thirdheader --> 
                <h3 class="fs3 rglr pdB innerpageHeading bottomSPce" id="tab3"><a href="javascript:void(0)">License and Restrictions</a></h3>
				 <div  style="display:none;">
					
							<ul class="listIng termsListing pdB1 mrB2 lightGray moreDetails">
                            
							<li><span class="blackCOlor">License: </span>Subject to the terms of this Agreement, Phone91 hereby grants You a limited, 
							...
							<li><span class="blackCOlor">No Granting of Rights to Third Parties:</span> You will not sell, assign, rent, 
							...
							<li><span class="blackCOlor">No Modifications:</span> You will not undertake, cause, permit or authorize 
							...
							<li><span class="blackCOlor">Third Parties:</span> You acknowledge and agree that the Phone91 Software may 
							...
							<p class="pdB1 lh25">Any such third party software or technology that is incorporated in the Phone91 Software falls 
							...
							<li><span class="blackCOlor">New Versions of the Phone91 Software: </span>Phone91, in its sole discretion, reserves the 
							...
							<li><span class="blackCOlor">Paid Services.</span> This Agreement applies to downloading, installing and using the 
               ...
               <!-- Fourheader -->  
                <h3 class="fs3 rglr pdB innerpageHeading bottomSPce" id="tab4"><a href="javascript:void(0)">Exceptions to License Restrictions </a></h3>
				 <div  style="display:none;">
						<ul class="listIng termsListing pdB1 mrB2 lightGray moreDetails">
    
							<li><span class="blackCOlor">Redistribution:</span>You are not allowed to redistribute the Phone91 Software, unless 
                            You have agreed to and meet with the Distribution Terms that are published on the Phone91 Website.</li>
							
							<li><span class="blackCOlor">API:</span> You are not allowed to use or modify the API, unless You agree 
							...
							<p class="pdB1 lh25">You will constantly monitor the Phone91 Website in order to ensure that You are distributing the 
							...
							<p class="lh25">You acknowledge and agree that Your use and/or modification of the API will be at Your own risk and account.</p> 
                            </li>
               ...
               <!-- Fiveheader -->  
                <h3 class="fs3 rglr pdB innerpageHeading bottomSPce" id="tab5"><a href="javascript:void(0)">Permission to Utilize</a></h3>
				 <div style="display:none;">
						<ul class="listIng termsListing pdB1 mrB2 lightGray moreDetails">    
               ...
               <!-- Sixheader -->  
                <h3 class="fs3 rglr pdB innerpageHeading bottomSPce" id="tab6"><a href="javascript:void(0)">Confidentiality and Privacy</a></h3>
				 <div  style="display:none;">					                 
						<ul class="listIng termsListing pdB1 mrB2 lightGray moreDetails">
	                    ...
	                    of Your personal data. The Privacy Policy that is published on the Phone91 Website applies to the use of Your personal data,                  		the traffic data as well as the content contained in Your communication(s).</li>
              ...
              <!-- sevenheader -->  
               <h3 class="fs3 rglr pdB innerpageHeading bottomSPce" id="tab7"><a href="javascript:void(0)">IP Rights and Translations</a></h3>
				 <div  style="display:none;">               
                		
                        <ul class="listIng termsListing pdB1 mrB2 lightGray moreDetails">
						<li><span class="blackCOlor">Exclusive Ownership:</span> You acknowledge and agree that any and all IP Rights are and shall 
						...
						<li><span class="blackCOlor">No Removal of Notices:</span> You agree that You will not remove, obscure, make 
                        illegible or alter any notices or indications of the IP Rights and/or Phone91's rights and ownership thereof.</li>
						
						
						<li><span class="blackCOlor"> Translations:</span> You acknowledge and agree that the intellectual property rights 
				       ...
				       <li><span class="blackCOlor">Use of Phone91 Promotional Materials:</span> You are not allowed to use the Phone91 
             ...
             <!-- eightheader -->  
	           <h3 class="fs3 rglr pdB innerpageHeading bottomSPce" id="tab8"><a href="javascript:void(0)">Communication and Your 
                	Use of the Phone91 <software>	</software></a></h3>
            	<div  style="display:none;">
	                <ul class="listIng termsListing pdB1 mrB2 lightGray moreDetails">
							<li><span class="blackCOlor">Communication:</span> Installing Phone91 Software enables You to communicate 
                            with other Phone91 Software users.</li>
                            
							<li><span class="blackCOlor">No Warranties:</span> Phone91 cannot guarantee that You will always be able
							...
							<li><span class="blackCOlor">No Control:</span> You acknowledge and understand that Phone91 does not control, 
							...
							<li><span class="blackCOlor">No Emergency Services:</span> You expressly agree and understand that the Phone91 
							...
							<li><span class="blackCOlor">Lawful purposes:</span> You acknowledge and agree to use the Phone91 Software solely 
             ...
             <!-- nineheader -->  
                <h3 class="fs3 rglr pdB innerpageHeading bottomSPce" id="tab9"><a href="javascript:void(0)">Term and (Consequences of) Termination</a></h3>
				 <div  style="display:none;">					
					 <ul class="listIng termsListing pdB1 mrB2 lightGray moreDetails">
						<li><span class="blackCOlor">Term:</span> This Agreement will be effective as of the Effective Date and will remain
                        	 effective until terminated by either Phone91 or You as set forth below.</li>
						
						<li><span class="blackCOlor">Termination by Phone91:</span> Phone91 may terminate this Agreement at any time, 
						...
						<li><span class="blackCOlor"> Termination by You:</span> You may terminate this Agreement at any time, with or 
                         without cause, provided that You will meet with the conditions as set forth in below.</li>
						
						<li><span class="blackCOlor">Consequences of Termination:</span> Upon termination of this Agreement, You</li>
								<ul class="normalList"> 
            ...
            <!-- tenheader -->  
               <h3 class="fs3 rglr pdB innerpageHeading bottomSPce" id="tab10"><a href="javascript:void(0)">Your Representations and Warranties; 
               	  Indemnification  of Phone91</a></h3>
				 <div  style="display:none;">                     
                		 
				      <ul class="listIng termsListing pdB1 mrB2 lightGray moreDetails">
				        <li><span class="blackCOlor">Representations:</span> You represent and warrant that You are authorized to enter into 
				        ...
				        <li><span class="blackCOlor">Indemnification:</span> You agree to indemnify, defend and hold Phone91, its Affiliates and 
            ...
            <!-- elevenheader -->  
               <h3 class="fs3 rglr pdB innerpageHeading bottomSPce" id="tab11"><a href="javascript:void(0)">Disclaimer of Warranties</a></h3>
				 	<div style="display:none;">                     
							<ul class="listIng termsListing pdB1 mrB2 lightGray moreDetails">       
								<li><span class="blackCOlor">No warranties:</span> The phone91 software is provided as is, with no warranties whatsoever;
								...
								<li><span class="blackCOlor"> Your own Risk:</span> You acknowledge and agree that the entire risk 
                                arising out of the use or performance of the Phone91 Software remains with You, to the maximum extent permitted by law.</li>
								
								<li><span class="blackCOlor">Jurisdiction's Limitations:</span> As some jurisdictions do not allow some 
            ...
            <!-- twelveheader-->  
               <h3 class="fs3 rglr pdB innerpageHeading bottomSPce" id="12"><a href="javascript:void(0)">Limitation of Liability</a></h3>
				 <div  style="display:none;">
                    
						<ul class="listIng termsListing pdB1 mrB2 lightGray moreDetails"> 
						
                        <li><span class="blackCOlor">No Liability:</span> The Phone91 Software is being provided to You free of charge. ACCORDINGLY, 
						...
						<li><span class="blackCOlor">Limitation of Liability: </span>In no event shall phone91, its affiliates or the phone91 
						...
						<li><span class="blackCOlor">Remedy: </span>Your only right or remedy with respect to any problems or dissatisfaction 
                        with the phone91 software is to deinstall and cease use of such phone91 software.</li>
						
						<li><span class="blackCOlor">11.4 Jurisdiction's Limitations.</span> As some jurisdictions do not allow some 
                        of the exclusions or limitations as set forth above, some of these exclusions or limitations may not apply to You.</li>
						</ul>						
                </div>
            <!-- //twelveheader --> 
            ...
            <!-- thirteenheader-->  
               <h3 class="fs3 rglr pdB innerpageHeading bottomSPce" id="tab13"><a href="javascript:void(0)">General Provisions</a></h3>
				 <div  style="display:none;">
     					 <ul class="listIng termsListing pdB1 mrB2 lightGray moreDetails">    
			         
								<li><span class="blackCOlor">New versions of the Agreement:</span> Phone91 reserves the right to modify this
								...
								<li><span class="blackCOlor">Entire Agreement:</span> The terms and conditions of this Agreement constitute the 
								...
								<li><span class="blackCOlor">Partial Invalidity:</span> Should any term or provision hereof be deemed invalid,
								...
								<li><span class="blackCOlor">No waiver:</span> The failure of Phone91 at any time or times to require performance of 
								...
								<li><span class="blackCOlor">No Assignment by You:</span> You are not allowed to assign this Agreement or any 
                                rights hereunder.</li>
								
								<li><span class="blackCOlor">Assignment by Phone91:</span> Phone91 is allowed to at its sole discretion assign this 
                                Agreement or any rights hereunder to any Affiliate, without giving prior notice.</li>
								
								<li><span class="blackCOlor">Applicable Law:</span> This Agreement shall be governed by and construed in accordance 
								...
								<li><span class="blackCOlor">Competent Court:</span> Any legal proceedings arising out of or relating to this Agreement 
            ...
            <!-- fourtheenheader-->  
                <h3 class="fs3 rglr pdB innerpageHeading bottomSPce" id="tab14"><a href="javascript:void(0)">Fair Use Policy</a></h3>
				 <div  style="display:none;">
							<ul class="listIng termsListing pdB1 mrB2 lightGray moreDetails"> 
                          
							<li class="listHead fwB grayClr2">Summary:</li>  
            ...
            <!-- fiftheenheader-->  
                <h3 class="fs3 rglr pdB innerpageHeading bottomSPce" id="tab15"><a href="javascript:void(0)">Excessive Use</a></h3>
				  <div  style="display:none;">
                        <ul class="listIng termsListing pdB1 mrB2 lightGray moreDetails">  
           ...
           <!-- sixteenheader-->  
               <h3 class="fs3 rglr pdB innerpageHeading bottomSPce" id="tab16"><a href="javascript:void(0)">Unreasonable Use</a></h3>
				 <div  style="display:none;"">
						<ul class="listIng termsListing pdB1 mrB2 lightGray moreDetails">        
            ...
            <!-- //sixteenheader --> 
             ...
             <!-- seventeebheader-->  
                <h3 class="fs3 rglr pdB innerpageHeading bottomSPce" id="17"><a href="javascript:void(0)">Our rights</a></h3>
				 <div style="display:none;">   
                   <ul class="listIng termsListing pdB1 mrB2 lightGray moreDetails lastBorder" >    
