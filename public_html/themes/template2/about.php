...
<title><?php echo $aboutMeta_title; ?></title>
...
<!--banner starts-->
	<div id="banner" style="background-image: url(<?php echo _MANAGE_PATH_.'/'.$welcomeImage;?>)" class="about">
    	<div class="wrapper">
...
<!--who we are-->
			<div>
				...
				<p class="bigD decriptPadd"> <span class="big"></span><?php echo $whoUR; ?></p>
				<div class="cl"></div>
            </div>
<!--our mission-->   
			<div>        
