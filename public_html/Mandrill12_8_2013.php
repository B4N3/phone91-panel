...
/**
  ...
  * @link https://mandrillapp.com/api/docs/index.html Official documentation for Mandrill API call types and calls
  * @link ../../examples/user_info.php Example: Calling User/Info per https://mandrillapp.com/api/docs/users.html#method=info
  *
  */
abstract class Mandrill {
    ...
    private static function _call_api(&$data) {
        ...
        curl_setopt($ch, CURLOPT_httpsHEADER, array(                                                                          
