...
function getCountryDetailsForMap()
{
  ...
  $.ajax({
    ...
    data: {"call": "getCountryGraphResellerWise",fromDate:fromDate,toDate:toDate},
    type: "post",
    dataType: "json",
    success: function(response)
    {
      ...
      if(response == null)
        ...
        console.log(country);
        if(country.length > 2)
          $('#getCountryDetailsGraphContainer').html('');
        else
        {
          $('#getCountryDetailsGraphContainer').html('NO Record found!');  
        }
...
function getCountryDetailForPie()
{
  ...
  $.ajax({
    url: "/controller/userCallLog.php",
    data: {"call": "getCountryPieDetailResellerWise",fromDate:fromDate,toDate:toDate},
    type: "post",
    dataType: "json",
    success: function(response)
    {
